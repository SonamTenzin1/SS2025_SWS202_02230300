    ...
    private static class f extends g {
        ...
        public void y(l lVar, Set<i.a.g.h> set) {
            ...
            if (o()) {
                ...
                while (it2.hasNext()) {
                    set.add(new h.e("_services._dns-sd._udp.local.", i.a.g.s.d.CLASS_IN, false, 3600, lVar.x0().get(it2.next()).f()));
                }
                return;
            }
            if (k()) {
                ...
                InetAddress o = lVar.n0().o();
                if (str.equalsIgnoreCase(o != null ? o.getHostAddress() : HttpUrl.FRAGMENT_ENCODE_SET)) {
                    if (q()) {
