...
class b {
    ...
    /* loaded from: classes.dex */
    public interface InterfaceC0079b<T, V> {
        V a(T t, int i2);
    ...
    private static class c<T> implements Comparator<T> {
        ...
        private final Rect f3297f = new Rect();

        /* renamed from: g, reason: collision with root package name */
        private final Rect f3298g = new Rect();

        /* renamed from: h, reason: collision with root package name */
        private final boolean f3299h;

        /* renamed from: i, reason: collision with root package name */
        private final a<T> f3300i;
        ...
        public int compare(T t, T t2) {
            Rect rect = this.f3297f;
            Rect rect2 = this.f3298g;
            this.f3300i.a(t, rect);
            this.f3300i.a(t2, rect2);
            int i2 = rect.top;
            int i3 = rect2.top;
            if (i2 < i3) {
                return -1;
    ...
    public static <L, T> T c(L l, InterfaceC0079b<L, T> interfaceC0079b, a<T> aVar, T t, Rect rect, int i2) {
        ...
        T t2 = null;
        int b2 = interfaceC0079b.b(l);
        Rect rect3 = new Rect();
        for (int i3 = 0; i3 < b2; i3++) {
            T a2 = interfaceC0079b.a(l, i3);
            if (a2 != t) {
                aVar.a(a2, rect3);
    ...
    public static <L, T> T d(L l, InterfaceC0079b<L, T> interfaceC0079b, a<T> aVar, T t, int i2, boolean z, boolean z2) {
        int b2 = interfaceC0079b.b(l);
        ArrayList arrayList = new ArrayList(b2);
        for (int i3 = 0; i3 < b2; i3++) {
            arrayList.add(interfaceC0079b.a(l, i3));
        }
