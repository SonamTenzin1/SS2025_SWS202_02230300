...
public class c {
    ...
    private boolean c(float f2, float f3, int i2, int i3) {
        ...
        if (abs >= abs2 * 0.5f || !this.s.g(i3)) {
            return (this.f3309j[i2] & i3) == 0 && abs > ((float) this.f3302c);
        }
    ...
    private boolean d(View view, float f2, float f3) {
        ...
        if (!z || !z2) {
            return z ? Math.abs(f2) > ((float) this.f3302c) : z2 && Math.abs(f3) > ((float) this.f3302c);
        }
    ...
    public static c l(ViewGroup viewGroup, float f2, AbstractC0080c abstractC0080c) {
        c m = m(viewGroup, abstractC0080c);
        m.f3302c = (int) (m.f3302c * (1.0f / f2));
        return m;
    }
    ...
    */
                ...
                if (actionMasked != 2) {
                    if (actionMasked != 3) {
                        if (actionMasked == 5) {
                            ...
                            } else if (i2 == 2 && (r = r((int) x, (int) y)) == this.t) {
                                I(r, pointerId);
                            }
                    ...
                    for (int i5 = 0; i5 < pointerCount; i5++) {
                        ...
                        if (x(pointerId2)) {
                            ...
                            boolean z2 = r2 != null && d(r2, f2, f3);
                            if (z2) {
                                int left = r2.getLeft();
                                int i6 = (int) f2;
                                int a2 = this.s.a(r2, left + i6, i6);
                                int top = r2.getTop();
                                int i7 = (int) f3;
                                int b2 = this.s.b(r2, top + i7, i7);
                                int d2 = this.s.d(r2);
                                int e2 = this.s.e(r2);
                                if (d2 != 0) {
                                    if (d2 > 0) {
    ...
    public boolean H(View view, int i2, int i3) {
        ...
        if (!s && this.f3301b == 0 && this.t != null) {
            this.t = null;
        }
        return s;
    }
    ...
    public void z(MotionEvent motionEvent) {
        ...
        if (actionMasked == 2) {
            if (this.f3301b == 1) {
                if (x(this.f3303d)) {
                    int findPointerIndex = motionEvent.findPointerIndex(this.f3303d);
