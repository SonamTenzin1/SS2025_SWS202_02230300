...
public final class a {
    ...
    private static final boolean f3401b = m(System.getProperty("java.vm.version"));
    ...
    public static final class C0089a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final InterfaceC0090a f3402b;
        ...
        /* loaded from: classes.dex */
        private static class b implements InterfaceC0090a {
            ...
            @Override // c.r.a.C0089a.InterfaceC0090a
        ...
        /* loaded from: classes.dex */
        private static class c implements InterfaceC0090a {
            private final Constructor<?> a;
        ...
        /* loaded from: classes.dex */
        private static class d implements InterfaceC0090a {
            private final Constructor<?> a;
        ...
        private C0089a() throws ClassNotFoundException, SecurityException, NoSuchMethodException {
            InterfaceC0090a dVar;
        ...
        private Object[] b(List<? extends File> list) throws IOException, SecurityException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                objArr[i2] = this.f3402b.a(file, DexFile.loadDex(file.getPath(), c(file), 0));
            }
            return objArr;
        }
    ...
    private static void e(Context context, File file, File file2, String str, String str2, boolean z) throws IOException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException {
        ...
        synchronized (set) {
            ...
            try {
                ...
                c.r.b bVar = new c.r.b(file, j2);
                IOException e2 = null;
                try {
                    try {
                        l(classLoader, j2, bVar.k(context, str2, false));
                    } catch (IOException e3) {
                        if (z) {
                            Log.w("MultiDex", "Failed to install extracted secondary dex files, retrying with forced extraction", e3);
                            l(classLoader, j2, bVar.k(context, str2, true));
                        } else {
                            throw e3;
                        }
                    }
