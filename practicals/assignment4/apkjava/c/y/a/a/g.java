...
public class g implements Interpolator {
    ...
    private void b(Path path) {
        ...
        if (min > 0) {
            ...
            this.f3643b = new float[min];
            float[] fArr = new float[2];
            for (int i3 = 0; i3 < min; i3++) {
                pathMeasure.getPosTan((i3 * length) / (min - 1), fArr, null);
                this.a[i3] = fArr[0];
                this.f3643b[i3] = fArr[1];
            }
            if (Math.abs(this.a[0]) <= 1.0E-5d && Math.abs(this.f3643b[0]) <= 1.0E-5d) {
                int i4 = min - 1;
                if (Math.abs(this.a[i4] - 1.0f) <= 1.0E-5d && Math.abs(this.f3643b[i4] - 1.0f) <= 1.0E-5d) {
                    float f2 = 0.0f;
                    int i5 = 0;
                    while (i2 < min) {
                        float[] fArr2 = this.a;
            ...
            sb.append(this.a[0]);
            sb.append(",");
            sb.append(this.f3643b[0]);
            sb.append(" end:");
            int i7 = min - 1;
            sb.append(this.a[i7]);
            sb.append(",");
            sb.append(this.f3643b[i7]);
    ...
    public float getInterpolation(float f2) {
        ...
        if (f3 == 0.0f) {
            return this.f3643b[i2];
        }
        float f4 = (f2 - fArr[i2]) / f3;
        float[] fArr2 = this.f3643b;
        float f5 = fArr2[i2];
