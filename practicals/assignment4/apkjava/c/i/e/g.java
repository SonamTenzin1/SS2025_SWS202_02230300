...
public class g extends e {
    ...
    public Typeface b(Context context, c.b bVar, Resources resources, int i2) {
        ...
        for (c.C0022c c0022c : bVar.a()) {
            if (!q(context, o, c0022c.a(), c0022c.c(), c0022c.e(), c0022c.f() ? 1 : 0, FontVariationAxis.fromFontVariationSettings(c0022c.d()))) {
                p(o);
                return null;
            }
        }
    ...
    protected Typeface l(Object obj) {
        try {
            Object newInstance = Array.newInstance(this.f3204g, 1);
