...
class e extends j {
    ...
    private static Typeface l(Object obj) {
        n();
        try {
            Object newInstance = Array.newInstance(f3195b, 1);
            Array.set(newInstance, 0, obj);
            return (Typeface) f3198e.invoke(null, newInstance);
        } catch (IllegalAccessException | InvocationTargetException e2) {
            throw new RuntimeException(e2);
        }
    }
    ...
    public Typeface b(Context context, c.b bVar, Resources resources, int i2) {
        ...
        for (c.C0022c c0022c : bVar.a()) {
            ...
            try {
                if (!k.c(e2, resources, c0022c.b())) {
                    return null;
                }
                if (!k(o, e2.getPath(), c0022c.e(), c0022c.f())) {
                    return null;
                }
                e2.delete();
