...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (z2 || this.C > 0 || this.D > 0) {
            ...
            this.f8886g.setMinimumWidth(width);
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f8885f);
        ...
        this.s = obtainStyledAttributes2.getColor(com.astuetz.a.d.f8899e, this.s);
        this.t = obtainStyledAttributes2.getDimensionPixelSize(com.astuetz.a.d.f8900f, this.t);
        ...
        this.y = obtainStyledAttributes2.getColor(com.astuetz.a.d.f8896b, this.y);
        this.w = obtainStyledAttributes2.getDimensionPixelSize(com.astuetz.a.d.f8898d, this.w);
        this.x = obtainStyledAttributes2.getDimensionPixelSize(com.astuetz.a.d.f8897c, this.x);
        this.E = obtainStyledAttributes2.getBoolean(com.astuetz.a.d.f8903i, this.E);
        this.K = obtainStyledAttributes2.getDimensionPixelSize(com.astuetz.a.d.f8902h, this.K);
        this.G = obtainStyledAttributes2.getBoolean(com.astuetz.a.d.f8901g, this.G);
        this.z = obtainStyledAttributes2.getDimensionPixelSize(com.astuetz.a.d.f8905k, this.z);
        this.M = obtainStyledAttributes2.getResourceId(com.astuetz.a.d.f8904j, this.M);
