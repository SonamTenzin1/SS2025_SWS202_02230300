...
public class a implements com.bumptech.glide.load.j<ByteBuffer, c> {
    ...
    public static class C0138a {
        ...
        com.bumptech.glide.l.a a(a.InterfaceC0122a interfaceC0122a, com.bumptech.glide.l.c cVar, ByteBuffer byteBuffer, int i2) {
    ...
    private e c(ByteBuffer byteBuffer, int i2, int i3, com.bumptech.glide.l.d dVar, com.bumptech.glide.load.i iVar) {
        ...
        try {
            ...
            if (c2.b() > 0 && c2.c() == 0) {
                ...
                com.bumptech.glide.l.a a2 = this.f9415f.a(this.f9416g, c2, byteBuffer, e(c2, i2, i3));
                a2.f(config);
                a2.c();
                Bitmap a3 = a2.a();
                if (a3 == null) {
                ...
                e eVar = new e(new c(this.f9412c, a2, com.bumptech.glide.load.o.b.a(), i2, i3, a3));
    ...
    public e b(ByteBuffer byteBuffer, int i2, int i3, com.bumptech.glide.load.i iVar) {
        com.bumptech.glide.l.d a2 = this.f9414e.a(byteBuffer);
        try {
