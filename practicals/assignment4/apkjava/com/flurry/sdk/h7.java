...
public final class h7 extends d7<i7> {
    ...
    final class b implements f7<p> {
        ...
        public final /* synthetic */ void a(p pVar) {
            ...
            if (i2 != 2) {
                if (i2 == 3 && (bundle = pVar2.f10968b) != null && bundle.containsKey("trim_memory_level") && bundle.getInt("trim_memory_level") == 20) {
                    h7.x(h7.this, false);
                    return;
                }
                return;
    ...
    private void z() {
        ...
        hashMap.put("current_state", this.q.f10835b.name());
        g0.a();
