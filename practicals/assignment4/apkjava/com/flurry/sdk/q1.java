...
public final class q1 {
    ...
    public final class a implements o1.b {
        ...
        final class ViewTreeObserverOnGlobalLayoutListenerC0166a implements ViewTreeObserver.OnGlobalLayoutListener {
            ...
            public final void onGlobalLayout() {
                ...
                double nanoTime = System.nanoTime() - q1.this.f11017f;
                Double.isNaN(nanoTime);
                m1Var.f10912h = (long) (nanoTime / 1000000.0d);
        ...
        public final void b(Activity activity) {
            ...
            if (i2 == 1 && !q1Var2.f11020i) {
                ...
                q1 q1Var3 = q1.this;
                double d2 = nanoTime - q1Var3.f11018g;
                Double.isNaN(d2);
                long j2 = (long) (d2 / 1000000.0d);
                q1Var3.f11018g = nanoTime;
                q1Var3.f11017f = nanoTime;
                if (q1Var3.f11016e) {
        ...
        public final void c(Activity activity) {
            m1 remove = q1.this.f11015d.remove(activity.toString());
            ...
            if (i2 == 0 && !q1Var.f11020i) {
                ...
                long nanoTime = System.nanoTime();
                q1 q1Var2 = q1.this;
                double d2 = nanoTime - q1Var2.f11018g;
                Double.isNaN(d2);
                long j2 = (long) (d2 / 1000000.0d);
                q1Var2.f11018g = nanoTime;
                if (q1Var2.f11016e) {
                    q1.b("fl.foreground.time", activity.getClass().getSimpleName(), j2);
                }
            }
            if (!q1.this.f11016e || remove == null) {
                return;
            }
            d1.c(3, "ScreenTimeMonitor", "End timed event: " + remove.f10906b);
            if (remove.f10910f) {
                d1.c(4, "ActivityScreenData", "End timed activity event: " + remove.f10906b);
                com.flurry.sdk.a v = com.flurry.sdk.a.v();
                String str = remove.a;
                v3.a aVar = v3.a.PERFORMANCE;
                double nanoTime2 = System.nanoTime() - remove.f10908d;
                Double.isNaN(nanoTime2);
                remove.f10909e.put("fl.duration", Long.toString((long) (nanoTime2 / 1000000.0d)));
                Map<String, String> map = remove.f10909e;
                if (!c2.g(16)) {
                    e.d.a.d dVar = e.d.a.d.kFlurryEventFailed;
                } else {
                    v.t(str, aVar, map, true, false);
                }
                remove.f10910f = false;
            }
        }
        ...
        public final void d(Activity activity) {
            ...
            double nanoTime = System.nanoTime() - q1.this.f11017f;
            Double.isNaN(nanoTime);
            m1Var.f10911g = (long) (nanoTime / 1000000.0d);
        }
    }
    ...
    public final void c() {
        ...
        long nanoTime = System.nanoTime();
        this.f11018g = nanoTime;
        this.f11017f = nanoTime;
        this.f11013b = new a();
        o1.a().c(this.f11013b);
    }
}
