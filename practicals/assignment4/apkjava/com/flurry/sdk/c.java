...
public final class c extends d7<b> implements Thread.UncaughtExceptionHandler {
    ...
    public c() {
        ...
        this.q = false;
        q7 a = q7.a();
        synchronized (a.f11026c) {
            a.f11026c.put(this, null);
        }
    }
    ...
    public final void uncaughtException(Thread thread, Throwable th) {
        ...
        if (this.q) {
            ...
            t(new b(p7.UNCAUGHT_EXCEPTION_ID.f11009i, currentTimeMillis, message, th.getClass().getName(), th, o7.a(), null, this.p.b()));
        }
    }
