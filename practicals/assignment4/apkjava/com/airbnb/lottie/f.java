...
public class f extends Drawable implements Drawable.Callback, Animatable {
    ...
    private void V() {
        ...
        float x = x();
        setBounds(0, 0, (int) (this.f8514h.b().width() * x), (int) (this.f8514h.b().height() * x));
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (f2 > 1.0f) {
            canvas.save();
            float width = this.f8514h.b().width() / 2.0f;
            float height = this.f8514h.b().height() / 2.0f;
            float f4 = width * r;
            float f5 = height * r;
