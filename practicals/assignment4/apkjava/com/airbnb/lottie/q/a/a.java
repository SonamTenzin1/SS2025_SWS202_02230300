...
public abstract class a implements a.InterfaceC0118a, j, d {
    ...
    private void i(Canvas canvas, b bVar, Matrix matrix) {
        ...
        float floatValue = (bVar.f8576b.h().h().floatValue() * length) / 360.0f;
        float floatValue2 = ((bVar.f8576b.i().h().floatValue() * length) / 100.0f) + floatValue;
        float floatValue3 = ((bVar.f8576b.e().h().floatValue() * length) / 100.0f) + floatValue;
        float f2 = 0.0f;
        for (int size2 = bVar.a.size() - 1; size2 >= 0; size2--) {
            ...
            if (floatValue3 > length) {
                ...
                if (f3 < f2 + length2 && f2 < f3) {
                    com.airbnb.lottie.v.f.a(this.f8567c, floatValue2 > length ? (floatValue2 - length) / length2 : 0.0f, Math.min(f3 / length2, 1.0f), 0.0f);
            ...
            if (f4 >= floatValue2 && f2 <= floatValue3) {
                if (f4 <= floatValue3 && floatValue2 < f2) {
                    ...
                    com.airbnb.lottie.v.f.a(this.f8567c, floatValue2 < f2 ? 0.0f : (floatValue2 - f2) / length2, floatValue3 <= f4 ? (floatValue3 - f2) / length2 : 1.0f, 0.0f);
                    canvas.drawPath(this.f8567c, this.f8573i);
                }
            }
            f2 += length2;
    ...
    public void d(RectF rectF, Matrix matrix) {
        ...
        float floatValue = this.f8574j.h().floatValue();
