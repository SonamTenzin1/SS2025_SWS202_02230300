...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private class d implements AppBarLayout.e {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                int i4 = cVar.a;
                if (i4 == 1) {
                    h2.f(c.i.g.a.b(-i2, 0, CollapsingToolbarLayout.this.g(childAt)));
                } else if (i4 == 2) {
                    h2.f(Math.round((-i2) * cVar.f18384b));
                }
            }
    ...
    protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (this.r && (view = this.f18383k) != null) {
            ...
            if (z2) {
                ...
                this.q.M(this.p.left + (z3 ? this.f18381i.getTitleMarginEnd() : this.f18381i.getTitleMarginStart()), this.p.top + g2 + this.f18381i.getTitleMarginTop(), this.p.right + (z3 ? this.f18381i.getTitleMarginStart() : this.f18381i.getTitleMarginEnd()), (this.p.bottom + g2) - this.f18381i.getTitleMarginBottom());
    ...
    */
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray h2 = j.h(context2, attributeSet, l.e1, i2, i3, new int[0]);
        aVar.Z(h2.getInt(l.i1, 8388691));
        aVar.R(h2.getInt(l.f1, 8388627));
        int dimensionPixelSize = h2.getDimensionPixelSize(l.j1, 0);
        ...
        int i4 = l.m1;
        if (h2.hasValue(i4)) {
            this.l = h2.getDimensionPixelSize(i4, 0);
        }
        int i5 = l.l1;
        if (h2.hasValue(i5)) {
            this.n = h2.getDimensionPixelSize(i5, 0);
        }
        int i6 = l.n1;
        if (h2.hasValue(i6)) {
            this.m = h2.getDimensionPixelSize(i6, 0);
        }
        int i7 = l.k1;
        if (h2.hasValue(i7)) {
            this.o = h2.getDimensionPixelSize(i7, 0);
        }
        this.r = h2.getBoolean(l.u1, true);
        setTitle(h2.getText(l.t1));
        aVar.W(k.f21031c);
        aVar.O(i.f2752b);
        int i8 = l.o1;
        if (h2.hasValue(i8)) {
            aVar.W(h2.getResourceId(i8, 0));
        }
        int i9 = l.g1;
        if (h2.hasValue(i9)) {
            aVar.O(h2.getResourceId(i9, 0));
        }
        this.z = h2.getDimensionPixelSize(l.r1, -1);
        int i10 = l.p1;
        if (h2.hasValue(i10)) {
            aVar.f0(h2.getInt(i10, 1));
        }
        this.y = h2.getInt(l.q1, 600);
        setContentScrim(h2.getDrawable(l.h1));
        setStatusBarScrim(h2.getDrawable(l.s1));
        this.f18380h = h2.getResourceId(l.v1, -1);
        h2.recycle();
