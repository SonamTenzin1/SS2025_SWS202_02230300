...
public final class a {
    ...
    /* loaded from: classes2.dex */
    class C0200a implements a.InterfaceC0262a {
        C0200a() {
        }
    ...
    private void b() {
        ...
        int b2 = androidx.core.view.d.b(this.f18693j, this.B ? 1 : 0);
        ...
        if (i2 == 48) {
            ...
            if (l0()) {
                centerY2 = this.f18690g.centerY() - descent;
            } else {
                centerY2 = descent2 + this.f18690g.centerY();
            }
            this.p = centerY2;
        } else {
        ...
        int i3 = b2 & 8388615;
        if (i3 == 1) {
            this.r = this.f18690g.centerX() - (measureText / 2.0f);
        } else if (i3 != 5) {
            this.r = this.f18690g.left;
        } else {
            this.r = this.f18690g.right - measureText;
        }
        g(this.f18694k);
        ...
        int b3 = androidx.core.view.d.b(this.f18692i, this.B ? 1 : 0);
        int i4 = b3 & 112;
        if (i4 == 48) {
            ...
            if (l0()) {
                centerY = this.f18689f.centerY() - (height / 2.0f);
            } else {
                centerY = descent3 + this.f18689f.centerY();
            }
            this.o = centerY;
        } else {
        ...
        int i5 = b3 & 8388615;
        if (i5 == 1) {
            this.q = this.f18689f.centerX() - (measureText2 / 2.0f);
        } else if (i5 != 5) {
            this.q = this.f18689f.left;
        } else {
            this.q = this.f18689f.right - measureText2;
        }
        h();
        e0(f2);
    }
    ...
    private void g(float f2) {
        ...
        float width = this.f18690g.width();
        float width2 = this.f18689f.width();
        if (F(f2, this.l)) {
            f3 = this.l;
            this.F = 1.0f;
    ...
    private StaticLayout i(int i2, float f2, boolean z) {
        ...
        return (StaticLayout) c.i.j.i.c(staticLayout);
    }
    ...
    private float q(int i2, int i3) {
        ...
        return ((i3 & 8388613) == 8388613 || (i3 & 5) == 5) ? this.B ? this.f18690g.left : this.f18690g.right - c() : this.B ? this.f18690g.right - c() : this.f18690g.left;
    }
    ...
    private float r(RectF rectF, int i2, int i3) {
        ...
        return ((i3 & 8388613) == 8388613 || (i3 & 5) == 5) ? this.B ? rectF.left + c() : this.f18690g.right : this.B ? this.f18690g.right : rectF.left + c();
    }
    ...
    public void d0(float f2) {
        float a2 = c.i.g.a.a(f2, 0.0f, 1.0f);
        if (a2 != this.f18688e) {
            this.f18688e = a2;
            d();
        }
