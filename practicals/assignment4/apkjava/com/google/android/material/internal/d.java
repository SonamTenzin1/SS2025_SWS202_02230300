...
public class d extends c0 {
    ...
    public d(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.y = true;
        this.z = false;
        TypedArray h2 = j.h(context, attributeSet, e.e.b.c.l.f2, i2, 0, new int[0]);
        this.x = h2.getInt(e.e.b.c.l.h2, this.x);
        Drawable drawable = h2.getDrawable(e.e.b.c.l.g2);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.y = h2.getBoolean(e.e.b.c.l.i2, true);
        h2.recycle();
    }
}
