...
public class g extends androidx.appcompat.widget.c {
    ...
    private int d() {
        ...
        int min = Math.min(adapter.getCount(), Math.max(0, this.f18815i.w()) + 15);
        View view = null;
        int i3 = 0;
        ...
        Drawable h2 = this.f18815i.h();
        if (h2 != null) {
            h2.getPadding(this.f18817k);
    ...
    public g(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray h2 = j.h(context2, attributeSet, l.r2, i2, k.f21034f, new int[0]);
        int i3 = l.s2;
