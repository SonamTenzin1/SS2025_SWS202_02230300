...
public class a extends FrameLayout implements n.a {
    ...
    public int[] onCreateDrawableState(int i2) {
        ...
        if (iVar != null && iVar.isCheckable() && this.q.isChecked()) {
            FrameLayout.mergeDrawableStates(onCreateDrawableState, f18466f);
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        y0.b0(c.C0025c.f(0, 1, getItemPosition(), 1, false, isSelected()));
        if (isSelected()) {
            y0.Z(false);
            y0.Q(c.a.f1038e);
        }
        y0.p0(getResources().getString(j.f21025g));
    }
