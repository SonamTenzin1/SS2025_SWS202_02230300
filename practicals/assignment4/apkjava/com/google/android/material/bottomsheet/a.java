...
public class a extends h {
    ...
    private static int b(Context context, int i2) {
        ...
        if (context.getTheme().resolveAttribute(e.e.b.c.b.f20966e, typedValue, true)) {
    ...
    private FrameLayout e() {
        if (this.f18502i == null) {
            ...
            BottomSheetBehavior<FrameLayout> T = BottomSheetBehavior.T((FrameLayout) frameLayout.findViewById(f.f21001d));
            this.f18501h = T;
            T.K(this.n);
