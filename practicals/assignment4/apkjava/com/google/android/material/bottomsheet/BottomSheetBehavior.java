...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    private final c.AbstractC0080c N;
    ...
    public class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            if (BottomSheetBehavior.this.f18487j != null) {
                BottomSheetBehavior.this.f18487j.Y(floatValue);
            }
        }
    }

    /* loaded from: classes2.dex */
    class c extends c.AbstractC0080c {
        c() {
        }
        ...
        public int b(View view, int i2, int i3) {
            ...
            BottomSheetBehavior bottomSheetBehavior = BottomSheetBehavior.this;
            return c.i.g.a.b(i2, U, bottomSheetBehavior.v ? bottomSheetBehavior.E : bottomSheetBehavior.t);
        }
    ...
    private int N() {
        if (this.f18484g) {
            return Math.max(this.f18485h, this.E - ((this.D * 9) / 16));
        }
        return this.f18483f;
    }
    ...
    private void s0() {
        ...
        int i2 = this.y;
        if (i2 == 3) {
            J(v, c.a.t, this.f18480c ? 4 : 6);
            return;
        }
        if (i2 == 4) {
            J(v, c.a.s, this.f18480c ? 3 : 6);
        } else {
            if (i2 != 6) {
                return;
            }
    ...
    public final void i0(int i2, boolean z) {
        ...
        if (i2 == -1) {
            ...
            if (this.f18484g || this.f18483f != i2) {
                this.f18484g = false;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.f18486i = obtainStyledAttributes.hasValue(l.d0);
        int i3 = l.T;
        boolean hasValue = obtainStyledAttributes.hasValue(i3);
        if (hasValue) {
            P(context, attributeSet, hasValue, e.e.b.c.x.c.a(context, obtainStyledAttributes, i3));
        } else {
