...
public class b {
    ...
    /* compiled from: FloatingActionButtonImpl.java */
    /* loaded from: classes2.dex */
    public class c extends e.e.b.c.m.g {
        c() {
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public b(FloatingActionButton floatingActionButton, e.e.b.c.z.b bVar) {
    ...
    private AnimatorSet h(e.e.b.c.m.h hVar, float f2, float f3, float f4) {
        ...
        g(f4, this.K);
        ObjectAnimator ofObject = ObjectAnimator.ofObject(this.F, new e.e.b.c.m.f(), new c(), new Matrix(this.K));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void P(e.e.b.c.m.h hVar) {
        this.x = hVar;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void X(e.e.b.c.a0.k kVar) {
        this.f18658h = kVar;
        e.e.b.c.a0.g gVar = this.f18659i;
        if (gVar != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void Y(e.e.b.c.m.h hVar) {
        this.w = hVar;
    }
    ...
    public void c0(j jVar, boolean z) {
        ...
        if (a0()) {
            ...
            e.e.b.c.m.h hVar = this.w;
            if (hVar == null) {
                hVar = m();
            }
            AnimatorSet h2 = h(hVar, 1.0f, 1.0f, 1.0f);
            h2.addListener(new C0199b(z, jVar));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final e.e.b.c.a0.k u() {
        return this.f18658h;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final e.e.b.c.m.h v() {
        return this.w;
    }
