...
public class zzgw {
    ...
    public static final String[] f18167b = {"_ab", "_cd", "_ae", "_ui", "_ug", "_in", "_au", "_cmp", "_err", "_f", "_v", "_iap", "_nd", "_nf", "_no", "_nr", "_ou", "_s", "_e", "_xa", "_xu", "_aq", "_aa", "_ai", "_ac", "_ar", "_vs", "_ep", "_ssr", "_cmp"};

    public static String a(String str) {
        return zzid.a(str, f18167b, a);
    }

    public static String b(String str) {
        return zzid.a(str, a, f18167b);
    }
}
