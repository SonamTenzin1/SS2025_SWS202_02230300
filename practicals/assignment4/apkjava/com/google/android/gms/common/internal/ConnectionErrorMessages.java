...
public final class ConnectionErrorMessages {
    ...
    public static String b(Context context) {
        return context.getResources().getString(R.string.f11563g);
    }

    public static String c(Context context, int i2) {
        Resources resources = context.getResources();
        if (i2 == 1) {
            return resources.getString(R.string.f11560d);
        }
        if (i2 == 2) {
            return resources.getString(R.string.f11566j);
        }
        if (i2 != 3) {
    ...
    public static String d(Context context, int i2) {
        ...
        String a2 = a(context);
        if (i2 == 1) {
            return resources.getString(R.string.f11561e, a2);
        }
        if (i2 == 2) {
            return DeviceProperties.e(context) ? resources.getString(R.string.n) : resources.getString(R.string.f11567k, a2);
        }
        if (i2 == 3) {
            return resources.getString(R.string.f11558b, a2);
        }
        if (i2 == 5) {
        ...
        if (i2 == 9) {
            return resources.getString(R.string.f11565i, a2);
        }
        if (i2 != 20) {
            switch (i2) {
                case 16:
    ...
    public static String f(Context context, int i2) {
        ...
        return g2 == null ? context.getResources().getString(R.string.f11564h) : g2;
    }
    ...
    public static String g(Context context, int i2) {
        ...
        switch (i2) {
            case 1:
                return resources.getString(R.string.f11562f);
            case 2:
                return resources.getString(R.string.l);
            case 3:
                return resources.getString(R.string.f11559c);
            case 4:
            case 6:
            case 18:
                return null;
