...
public final class SignInButtonImpl extends Button {
    ...
    public final void a(Resources resources, int i2, int i3) {
        ...
        setMinHeight(i4);
        setMinWidth(i4);
        int i5 = R.drawable.f11554b;
        int i6 = R.drawable.f11555c;
        int b2 = b(i3, i5, i6, i6);
        int i7 = R.drawable.f11556d;
        int i8 = R.drawable.f11557e;
        ...
        androidx.core.graphics.drawable.a.o(r, resources.getColorStateList(R.color.f11553c));
        androidx.core.graphics.drawable.a.p(r, PorterDuff.Mode.SRC_ATOP);
        setBackgroundDrawable(r);
        int i9 = R.color.a;
        int i10 = R.color.f11552b;
        setTextColor((ColorStateList) Preconditions.k(resources.getColorStateList(b(i3, i9, i10, i10))));
        if (i2 == 0) {
