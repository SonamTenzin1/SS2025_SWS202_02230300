...
public final class zzazt {
    ...
    public static String c(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        while (true) {
            ...
            i2 = ("loadAd".equalsIgnoreCase(stackTraceElement.getMethodName()) && (f14314b.equalsIgnoreCase(className) || f14315c.equalsIgnoreCase(className) || f14316d.equalsIgnoreCase(className) || f14317e.equalsIgnoreCase(className) || f14318f.equalsIgnoreCase(className) || f14319g.equalsIgnoreCase(className))) ? 0 : i3;
        }
    ...
    private final void g(ViewGroup viewGroup, zzyd zzydVar, String str, int i2, int i3) {
        ...
        int a2 = a(context, 3);
        frameLayout.addView(textView, new FrameLayout.LayoutParams(zzydVar.f16992k - a2, zzydVar.f16989h - a2, 17));
