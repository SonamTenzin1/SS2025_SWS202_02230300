    ...
    */
    private final JSONObject A(View view) {
        ...
        try {
            ...
            jSONObject3.put("width", x(view.getMeasuredWidth()));
            jSONObject3.put("height", x(view.getMeasuredHeight()));
            jSONObject3.put("x", x(E[0]));
            jSONObject3.put("y", x(E[1]));
            ...
            if (view.getGlobalVisibleRect(rect)) {
                ...
                jSONObject4.put("x", x(E[0]));
                jSONObject4.put("y", x(E[1]));
    ...
    private final String D(View view) {
        try {
            JSONObject optJSONObject = this.f14826c.optJSONObject("tracking_urls_and_actions");
            if (optJSONObject == null) {
                optJSONObject = new JSONObject();
            }
            return this.f14829f.f().zza(this.a, optJSONObject.optString("click_string"), view);
        } catch (Exception e2) {
    ...
    private final boolean y(String str) {
        JSONObject optJSONObject = this.f14826c.optJSONObject("allow_pub_event_reporting");
