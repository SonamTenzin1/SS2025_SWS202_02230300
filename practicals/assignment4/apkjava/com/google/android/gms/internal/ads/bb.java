...
final class bb extends WebView implements ViewTreeObserver.OnGlobalLayoutListener, DownloadListener, zzbgz {
    ...
    private final boolean C0() {
        ...
        if (b2 == null || b2.getWindow() == null) {
            ...
            int[] P = zzaxi.P(b2);
            zzyt.a();
            int k4 = zzazt.k(this.f12339k, P[0]);
            zzyt.a();
            i3 = zzazt.k(this.f12339k, P[1]);
            i2 = k4;
        }
        int i4 = this.S;
        ...
        this.T = i2;
        this.U = i3;
        new zzaqb(this).c(k2, k3, i2, i3, this.f12339k.density, this.W.getDefaultDisplay().getRotation());
        return z;
    }
    ...
    public final void J() {
        ...
        hashMap.put("version", this.f12336h.f14326f);
        y("onhide", hashMap);
    }
        ...
        if (!isInEditMode() && !this.v && !this.r.f()) {
            ...
            if (this.r.a()) {
                if (!((Boolean) zzyt.e().c(zzacu.U2)).booleanValue() && PlatformVersion.d()) {
                    ...
                    int i7 = this.I;
                    setMeasuredDimension(size3, i7 != -1 ? (int) (i7 * f2) : View.MeasureSpec.getSize(i3));
                    return;
                }
                super.onMeasure(i2, i3);
                return;
            ...
            if (mode != Integer.MIN_VALUE && mode != 1073741824) {
                ...
                if (zzbinVar.f14472c <= i4 && zzbinVar.f14471b <= i8) {
                    ...
                    if (((Boolean) zzyt.e().c(zzacu.n4)).booleanValue()) {
                        ...
                        float f4 = this.l;
                        boolean z2 = f3 / f4 <= ((float) i4) / f4 && ((float) zzbinVar2.f14471b) / f4 <= ((float) i8) / f4;
                        if (z) {
                            z = z2;
                        }
                    }
                    if (!z) {
                        float f5 = this.r.f14472c;
                        float f6 = this.l;
                        StringBuilder sb = new StringBuilder(103);
                        sb.append("Not enough space to show ad. Needs ");
                        sb.append((int) (f5 / f6));
                        sb.append("x");
                        sb.append((int) (r2.f14471b / f6));
