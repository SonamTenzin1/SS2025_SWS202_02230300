...
abstract class dv<T extends zzdno> {
    ...
    public static <T extends zzdno> T b(Class<T> cls) {
        ...
        if (cls.equals(zzdno.class)) {
            format = f12487b;
        } else if (cls.getPackage().equals(dv.class.getPackage())) {
        ...
        try {
            try {
                try {
                    try {
                        return cls.cast(((dv) Class.forName(format, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).a());
