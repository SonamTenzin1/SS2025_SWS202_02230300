...
public final class zzua implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public final void f(int i2) {
        ...
        if (z5 || this.q || i2 != 1) {
            zzud zzudVar = new zzud(zzk.zzln().b(), this.f16795j.isScreenOn(), view != null && zzk.zzli().b(view), view != null ? view.getWindowVisibility() : 8, a(this.u), a(rect), a(rect2), z, a(rect3), z2, a(rect4), this.t.density, z5, list);
