...
final class b9 implements zzjp {
    ...
    public final long a(zzjq zzjqVar) throws IOException {
        ...
        if (j5 == -1 || zzjqVar.f16359c + j5 > this.f12325b) {
            long max = Math.max(this.f12325b, zzjqVar.f16359c);
            long j6 = zzjqVar.f16360d;
            zzjqVar3 = new zzjq(zzjqVar.a, max, j6 != -1 ? Math.min(j6, (zzjqVar.f16359c + j6) - this.f12325b) : -1L, null);
        }
        long a = zzjqVar2 != null ? this.a.a(zzjqVar2) : 0L;
        long a2 = zzjqVar3 != null ? this.f12326c.a(zzjqVar3) : 0L;
    ...
    public final int read(byte[] bArr, int i2, int i3) throws IOException {
        ...
        int read = this.f12326c.read(bArr, i2 + i4, i3 - i4);
        int i5 = i4 + read;
        this.f12327d += read;
        return i5;
    }
