...
public final class zzc extends AbstractSafeParcelable {
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.u(parcel, 2, this.zzdjg, false);
        SafeParcelWriter.u(parcel, 3, this.url, false);
        SafeParcelWriter.u(parcel, 4, this.mimeType, false);
        SafeParcelWriter.u(parcel, 5, this.packageName, false);
        SafeParcelWriter.u(parcel, 6, this.zzdjh, false);
        SafeParcelWriter.u(parcel, 7, this.zzdji, false);
        SafeParcelWriter.u(parcel, 8, this.zzdjj, false);
        SafeParcelWriter.s(parcel, 9, this.intent, i2, false);
