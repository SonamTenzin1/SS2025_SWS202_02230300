...
public class zzd extends zzaqh implements zzx {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (zzc != null) {
                ...
                Activity activity = this.mActivity;
                AdOverlayInfoParcel adOverlayInfoParcel2 = this.zzdjl;
                zzi zziVar = new zzi(activity, adOverlayInfoParcel2.zzdks, adOverlayInfoParcel2.zzbtc.f14326f);
                this.zzdju = zziVar;
                zziVar.setId(1000);
    ...
    public final void zzac(IObjectWrapper iObjectWrapper) {
        zza((Configuration) ObjectWrapper.k0(iObjectWrapper));
    }
