...
public final class UnifiedNativeAdView extends FrameLayout {
    ...
    private final View zzbj(String str) {
        try {
            ...
            if (n4 != null) {
                return (View) ObjectWrapper.k0(n4);
            }
            return null;
        } catch (RemoteException e2) {
    ...
    private final zzaem zzks() {
        Preconditions.l(this.zzbqi, "createDelegate must be called after overlayFrame has been created");
        if (isInEditMode()) {
            return null;
        }
    ...
    public final void setClickConfirmingView(View view) {
        try {
            this.zzbqj.x0(ObjectWrapper.E0(view));
        } catch (RemoteException e2) {
    ...
    public final void setNativeAd(UnifiedNativeAd unifiedNativeAd) {
        try {
            this.zzbqj.V((IObjectWrapper) unifiedNativeAd.zzkq());
        } catch (RemoteException e2) {
