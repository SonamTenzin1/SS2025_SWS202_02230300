...
public class AdLoader {
    ...
    private final void zza(zzaaz zzaazVar) {
        try {
            this.zzaak.j2(zzyc.a(this.zzlj, zzaazVar));
    ...
    public void loadAds(AdRequest adRequest, int i2) {
        try {
            this.zzaak.F5(zzyc.a(this.zzlj, adRequest.zzde()), i2);
        } catch (RemoteException e2) {
    ...
    public static class Builder {
        ...
        public Builder(Context context, String str) {
            this((Context) Preconditions.l(context, "context cannot be null"), zzyt.b().g(context, str, new zzamo()));
        }

        public AdLoader build() {
            try {
                return new AdLoader(this.zzlj, this.zzaal.J1());
            } catch (RemoteException e2) {
        ...
        public Builder forAppInstallAd(NativeAppInstallAd.OnAppInstallAdLoadedListener onAppInstallAdLoadedListener) {
            try {
                this.zzaal.G3(new zzagm(onAppInstallAdLoadedListener));
            } catch (RemoteException e2) {
        ...
        public Builder forContentAd(NativeContentAd.OnContentAdLoadedListener onContentAdLoadedListener) {
            try {
                this.zzaal.y1(new zzagn(onContentAdLoadedListener));
            } catch (RemoteException e2) {
        ...
        public Builder forCustomTemplateAd(String str, NativeCustomTemplateAd.OnCustomTemplateAdLoadedListener onCustomTemplateAdLoadedListener, NativeCustomTemplateAd.OnCustomClickListener onCustomClickListener) {
            try {
                this.zzaal.D5(str, new zzagp(onCustomTemplateAdLoadedListener), onCustomClickListener == null ? null : new zzago(onCustomClickListener));
            } catch (RemoteException e2) {
        ...
        public Builder forPublisherAdView(OnPublisherAdViewLoadedListener onPublisherAdViewLoadedListener, AdSize... adSizeArr) {
            if (adSizeArr != null && adSizeArr.length > 0) {
                try {
                    this.zzaal.i1(new zzagq(onPublisherAdViewLoadedListener), new zzyd(this.zzlj, adSizeArr));
                } catch (RemoteException e2) {
        ...
        public Builder forUnifiedNativeAd(UnifiedNativeAd.OnUnifiedNativeAdLoadedListener onUnifiedNativeAdLoadedListener) {
            try {
                this.zzaal.Z3(new zzags(onUnifiedNativeAdLoadedListener));
            } catch (RemoteException e2) {
        ...
        public Builder withAdListener(AdListener adListener) {
            try {
                this.zzaal.e2(new zzxv(adListener));
            } catch (RemoteException e2) {
        ...
        public Builder withCorrelator(Correlator correlator) {
            Preconditions.k(correlator);
            try {
                this.zzaal.q5(correlator.zzaar);
            } catch (RemoteException e2) {
        ...
        public Builder withNativeAdOptions(NativeAdOptions nativeAdOptions) {
            try {
                this.zzaal.k6(new zzady(nativeAdOptions));
            } catch (RemoteException e2) {
        ...
        public Builder withPublisherAdViewOptions(PublisherAdViewOptions publisherAdViewOptions) {
            try {
                this.zzaal.X1(publisherAdViewOptions);
            } catch (RemoteException e2) {
