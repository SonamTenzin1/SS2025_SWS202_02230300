...
public final /* data */ class Segment {
    ...
    public final Segment copy(long id, String description, List<Constraint> constraints, List<Distribution> distributions, long rank, long rolloutPercent) {
        ...
        m.f(distributions, "distributions");
    ...
    public boolean equals(Object other) {
        ...
        return this.id == segment.id && m.a(this.description, segment.description) && m.a(this.constraints, segment.constraints) && m.a(this.distributions, segment.distributions) && this.rank == segment.rank && this.rolloutPercent == segment.rolloutPercent;
    }
