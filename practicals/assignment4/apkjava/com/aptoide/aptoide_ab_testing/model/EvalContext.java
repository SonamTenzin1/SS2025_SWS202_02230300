...
public final /* data */ class EvalContext {
    ...
    public EvalContext(String str, String str2, l lVar, boolean z, long j2, String str3, List<String> list, String str4) {
        m.f(str, "entityID");
        m.f(str2, "entityType");
        m.f(lVar, "entityContext");
        m.f(str3, "flagKey");
        m.f(list, "flagTags");
        m.f(str4, "flagTagsOperator");
        this.entityID = str;
    ...
    public boolean equals(Object other) {
        ...
        return m.a(this.entityID, evalContext.entityID) && m.a(this.entityType, evalContext.entityType) && m.a(this.entityContext, evalContext.entityContext) && this.enableDebug == evalContext.enableDebug && this.flagID == evalContext.flagID && m.a(this.flagKey, evalContext.flagKey) && m.a(this.flagTags, evalContext.flagTags) && m.a(this.flagTagsOperator, evalContext.flagTagsOperator);
    }
