...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    */
    private void _writeSegmentASCII(int i2, int i3) throws IOException, JsonGenerationException {
        char[] cArr;
        char c2;
        int[] iArr = this._outputEscapes;
        ...
        while (i4 < i2) {
            ...
            i4++;
            i5 = _prependOrWriteCharacterEscape(this._outputBuffer, i4, i2, c2, i6);
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private void _writeSegmentCustom(int i2) throws IOException, JsonGenerationException {
        int i3;
        int i4;
        int i5;
        int[] iArr = this._outputEscapes;
        ...
        while (i7 < i2) {
            do {
                ...
                i7++;
                i8 = _prependOrWriteCharacterEscape(this._outputBuffer, i7, i2, c2, i3);
            } while (i7 < i2);
            i3 = i5;
            i4 = i7 - i8;
            if (i4 <= 0) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private void _writeStringASCII(int i2, int i3) throws IOException, JsonGenerationException {
        int i4;
        int i5;
        int i6;
        int i7 = this._outputTail + i2;
        int[] iArr = this._outputEscapes;
        int min = Math.min(iArr.length, i3 + 1);
            ...
            do {
                ...
                if (c2 < min) {
                    ...
                    if (i4 != 0) {
                        ...
                        i5 = i8 - i9;
                        if (i5 <= 0) {
                            this._writer.write(cArr, i9, i5);
                        }
                        this._outputTail++;
                        _prependOrWriteCharacterEscape(c2, i4);
                    }
                    i6 = i8 + 1;
                    this._outputTail = i6;
                } else {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private void _writeStringASCII(char[] cArr, int i2, int i3, int i4) throws IOException, JsonGenerationException {
        char c2;
        int i5 = i3 + i2;
        int[] iArr = this._outputEscapes;
