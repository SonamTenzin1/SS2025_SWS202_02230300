...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    private static final class a implements Serializable {
        ...
        private final Object readResolve() {
            ...
            CoroutineContext coroutineContext = EmptyCoroutineContext.f25609f;
    ...
    public CoroutineContext minusKey(CoroutineContext.c<?> cVar) {
        ...
        CoroutineContext minusKey = this.f25599f.minusKey(cVar);
        return minusKey == this.f25599f ? this : minusKey == EmptyCoroutineContext.f25609f ? this.f25600g : new CombinedContext(minusKey, this.f25600g);
    }
