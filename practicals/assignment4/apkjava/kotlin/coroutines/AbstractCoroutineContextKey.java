...
public abstract class AbstractCoroutineContextKey<B extends CoroutineContext.b, E extends B> implements CoroutineContext.c<E> {
    ...
    private final Function1<CoroutineContext.b, E> f25597f;

    /* renamed from: g, reason: collision with root package name */
    private final CoroutineContext.c<?> f25598g;
    ...
    public AbstractCoroutineContextKey(CoroutineContext.c<B> cVar, Function1<? super CoroutineContext.b, ? extends E> function1) {
        ...
        this.f25597f = function1;
        this.f25598g = cVar instanceof AbstractCoroutineContextKey ? (CoroutineContext.c<B>) ((AbstractCoroutineContextKey) cVar).f25598g : cVar;
    }

    public final boolean a(CoroutineContext.c<?> cVar) {
        m.f(cVar, RoomNotification.KEY);
        return cVar == this || this.f25598g == cVar;
    }
    ...
    public final CoroutineContext.b b(CoroutineContext.b bVar) {
        m.f(bVar, "element");
        return (CoroutineContext.b) this.f25597f.invoke(bVar);
    }
}
