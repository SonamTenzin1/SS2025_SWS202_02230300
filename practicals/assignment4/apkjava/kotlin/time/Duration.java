...
public final class Duration implements Comparable<Duration> {
    ...
    private static final long f25091g = v(0);

    /* renamed from: h, reason: collision with root package name */
    private static final long f25092h;

    /* renamed from: i, reason: collision with root package name */
    private static final long f25093i;

    /* renamed from: j, reason: collision with root package name */
    private final long f25094j;
    ...
    public static final long D(long j2) {
        return U(j2, DurationUnit.DAYS);
    }

    public static final long E(long j2) {
        return U(j2, DurationUnit.HOURS);
    }

    public static final long F(long j2) {
        return (P(j2) && O(j2)) ? M(j2) : U(j2, DurationUnit.MILLISECONDS);
    }

    public static final long G(long j2) {
        return U(j2, DurationUnit.MINUTES);
    }

    public static final long H(long j2) {
        return U(j2, DurationUnit.SECONDS);
    }
    ...
    public static final int J(long j2) {
        ...
        if (P(j2)) {
            ...
            M = M(j2) % Http2Connection.DEGRADED_PONG_TIMEOUT_NS;
        }
        return (int) M;
    }
    ...
    private static final DurationUnit L(long j2) {
    ...
    public static final long U(long j2, DurationUnit durationUnit) {
        ...
        return e.a(M(j2), L(j2), durationUnit);
    }
    ...
    public static String V(long j2) {
        ...
        if (z4) {
            ...
            if (K != 0 || z || z2 || z3) {
                g(j2, sb, K, J, 9, "s", false);
            } else if (J >= 1000000) {
                g(j2, sb, J / 1000000, J % 1000000, 6, "ms", false);
            } else if (J >= 1000) {
                g(j2, sb, J / 1000, J % 1000, 3, "us", false);
            } else {
                sb.append(J);
                sb.append("ns");
            }
    ...
    private static final void g(long j2, StringBuilder sb, int i2, int i3, int i4, String str, boolean z) {
        String g0;
        sb.append(i2);
        if (i3 != 0) {
            sb.append('.');
            g0 = v.g0(String.valueOf(i3), i4, '0');
            int i5 = -1;
            ...
            int i7 = i5 + 1;
            if (!z && i7 < 3) {
                sb.append((CharSequence) g0, 0, i7);
                m.e(sb, "this.append(value, startIndex, endIndex)");
            } else {
                sb.append((CharSequence) g0, 0, ((i7 + 2) / 3) * 3);
                m.e(sb, "this.append(value, startIndex, endIndex)");
            }
        }
        sb.append(str);
    ...
    public static final /* synthetic */ Duration k(long j2) {
    ...
    public static long v(long j2) {
        if (b.a()) {
            if (Q(j2)) {
                if (!new LongRange(-4611686018426999999L, 4611686018426999999L).i(M(j2))) {
                    throw new AssertionError(M(j2) + " ns is out of nanoseconds range");
                }
            } else if (new LongRange(-4611686018427387903L, 4611686018427387903L).i(M(j2))) {
                if (new LongRange(-4611686018426L, 4611686018426L).i(M(j2))) {
    ...
    public static boolean x(long j2, Object obj) {
        return (obj instanceof Duration) && j2 == ((Duration) obj).getF25094j();
    }
    ...
    public final /* synthetic */ long getF25094j() {
        return this.f25094j;
    }

    @Override // java.lang.Comparable
    public /* bridge */ /* synthetic */ int compareTo(Duration duration) {
        return q(duration.getF25094j());
    }

    public boolean equals(Object obj) {
        return x(this.f25094j, obj);
    }

    public int hashCode() {
        return N(this.f25094j);
    }

    public int q(long j2) {
        return u(this.f25094j, j2);
    }

    public String toString() {
        return V(this.f25094j);
    }
}
