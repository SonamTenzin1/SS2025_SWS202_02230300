...
public final class i extends n {
    public static /* bridge */ /* synthetic */ <T> T o(Sequence<? extends T> sequence) {
        return (T) n.o(sequence);
    }

    public static /* bridge */ /* synthetic */ <T> T t(Sequence<? extends T> sequence) {
        return (T) n.t(sequence);
    }
}
