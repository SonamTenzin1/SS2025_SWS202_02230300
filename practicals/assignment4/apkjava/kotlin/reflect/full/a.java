...
public final class a {
    public static final <T> Collection<KProperty1<T, ?>> a(KClass<T> kClass) {
        m.f(kClass, "<this>");
        Collection<KCallableImpl<?>> g2 = ((KClassImpl) kClass).Q().invoke().g();
    ...
    public static final <T> KFunction<T> b(KClass<T> kClass) {
        T t;
        m.f(kClass, "<this>");
        Iterator<T> it = ((KClassImpl) kClass).P().iterator();
        while (true) {
            if (!it.hasNext()) {
                t = null;
                break;
            ...
            m.d(kFunction, "null cannot be cast to non-null type kotlin.reflect.jvm.internal.KFunctionImpl");
            y F = ((KFunctionImpl) kFunction).F();
            m.d(F, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ConstructorDescriptor");
            if (((l) F).B()) {
                break;
            }
        }
