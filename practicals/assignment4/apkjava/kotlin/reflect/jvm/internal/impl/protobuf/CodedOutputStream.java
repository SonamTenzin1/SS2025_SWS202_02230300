...
public final class CodedOutputStream {
    ...
    private final OutputStream f25389e;
    ...
    private CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f25389e = outputStream;
        this.a = bArr;
        this.f25386b = bArr.length;
    }
    ...
    private void K() throws IOException {
        OutputStream outputStream = this.f25389e;
        if (outputStream != null) {
            outputStream.write(this.a, 0, this.f25387c);
            this.f25387c = 0;
            return;
        }
    ...
    public void j0(d dVar, int i2, int i3) throws IOException {
        ...
        int i5 = this.f25387c;
        if (i4 - i5 >= i3) {
            dVar.o(this.a, i2, i5, i3);
            this.f25387c += i3;
            this.f25388d += i3;
            return;
        }
        int i6 = i4 - i5;
        dVar.o(this.a, i2, i5, i6);
        int i7 = i2 + i6;
        int i8 = i3 - i6;
        this.f25387c = this.f25386b;
        this.f25388d += i6;
        K();
        if (i8 <= this.f25386b) {
            dVar.o(this.a, i7, 0, i8);
            this.f25387c = i8;
        } else {
            dVar.E(this.f25389e, i7, i8);
        }
        this.f25388d += i8;
    }
