...
public abstract class j extends kotlin.reflect.jvm.internal.impl.descriptors.n1.b implements kotlin.reflect.jvm.internal.impl.descriptors.m {
    ...
    private final kotlin.reflect.y.internal.j0.f.f f25244g;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(kotlin.reflect.jvm.internal.impl.descriptors.n1.g gVar, kotlin.reflect.y.internal.j0.f.f fVar) {
        super(gVar);
        if (gVar == null) {
            v(0);
        }
    ...
    public static String H(kotlin.reflect.jvm.internal.impl.descriptors.m mVar) {
        ...
        try {
            String str = kotlin.reflect.y.internal.j0.h.c.f24255j.q(mVar) + "[" + mVar.getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(mVar)) + "]";
            if (str == null) {
                v(5);
            }
            return str;
    ...
    public kotlin.reflect.y.internal.j0.f.f getName() {
        kotlin.reflect.y.internal.j0.f.f fVar = this.f25244g;
        if (fVar == null) {
            v(2);
        }
        return fVar;
