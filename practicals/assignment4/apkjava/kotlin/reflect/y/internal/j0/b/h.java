...
public abstract class h {
    ...
    private final g<f, kotlin.reflect.jvm.internal.impl.descriptors.e> f23163f;
    ...
    class b implements Function0<e> {
        ...
        public e invoke() {
            ...
            for (i iVar : i.values()) {
                m0 q = h.this.q(iVar.v().k());
                m0 q2 = h.this.q(iVar.q().k());
    ...
    class c implements Function1<f, kotlin.reflect.jvm.internal.impl.descriptors.e> {
        ...
        public kotlin.reflect.jvm.internal.impl.descriptors.e invoke(f fVar) {
            kotlin.reflect.jvm.internal.impl.descriptors.h f2 = h.this.s().f(fVar, kotlin.reflect.y.internal.j0.c.b.d.FROM_BUILTINS);
            if (f2 != null) {
    ...
    private static e0 A(e0 e0Var, g0 g0Var) {
        ...
        o oVar = o.a;
        if (!oVar.b(c2.getName()) || (g2 = kotlin.reflect.y.internal.j0.i.t.a.g(c2)) == null || (a2 = oVar.a(g2)) == null || (a3 = kotlin.reflect.jvm.internal.impl.descriptors.x.a(g0Var, a2)) == null) {
            return null;
        }
        return a3.s();
    }
    ...
    private static boolean e(kotlin.reflect.jvm.internal.impl.descriptors.h hVar, kotlin.reflect.y.internal.j0.f.d dVar) {
        if (hVar == null) {
            a(103);
        }
        if (dVar == null) {
    ...
    private kotlin.reflect.jvm.internal.impl.descriptors.e p(String str) {
        ...
        kotlin.reflect.jvm.internal.impl.descriptors.e invoke = this.f23163f.invoke(f.x(str));
        if (invoke == null) {
            a(15);
        }
        return invoke;
    ...
    public kotlin.reflect.jvm.internal.impl.descriptors.e X(int i2) {
        kotlin.reflect.jvm.internal.impl.descriptors.e o = o(k.f23199j.c(f.x(k.d(i2))));
        if (o == null) {
            a(18);
        }
        return o;
    ...
    public e0 k(e0 e0Var) {
        ...
        e0 n = n1.n(e0Var);
        m0 m0Var = this.f23161d.invoke().f23171c.get(n);
        if (m0Var != null) {
            return m0Var;
        }
        g0 i2 = kotlin.reflect.y.internal.j0.i.d.i(n);
    ...
    public m0 l(r1 r1Var, e0 e0Var) {
        ...
        m0 m = m(r1Var, e0Var, kotlin.reflect.jvm.internal.impl.descriptors.n1.g.f25179c.b());
        if (m == null) {
            a(84);
        }
        return m;
    ...
    public kotlin.reflect.jvm.internal.impl.descriptors.e o(kotlin.reflect.y.internal.j0.f.c cVar) {
        if (cVar == null) {
            a(12);
        }
        kotlin.reflect.jvm.internal.impl.descriptors.e c2 = s.c(r(), cVar, kotlin.reflect.y.internal.j0.c.b.d.FROM_BUILTINS);
        if (c2 == null) {
            a(13);
        }
        return c2;
    ...
    public kotlin.reflect.y.internal.j0.i.w.h s() {
        kotlin.reflect.y.internal.j0.i.w.h q = r().N(k.r).q();
        if (q == null) {
            a(11);
        }
        return q;
    ...
    public Iterable<kotlin.reflect.jvm.internal.impl.descriptors.o1.b> v() {
        List singletonList = Collections.singletonList(new kotlin.reflect.y.internal.j0.b.p.a(this.f23164g, r()));
