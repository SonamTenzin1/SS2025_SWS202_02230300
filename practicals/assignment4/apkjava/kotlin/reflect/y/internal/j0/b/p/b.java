...
public final class b extends kotlin.reflect.jvm.internal.impl.descriptors.p1.a {
    ...
    /* compiled from: FunctionClassDescriptor.kt */
    /* renamed from: kotlin.f0.y.e.j0.b.p.b$b, reason: collision with other inner class name */
    /* loaded from: classes2.dex */
    private final class C0322b extends kotlin.reflect.y.internal.j0.l.b {
        ...
        protected Collection<e0> l() {
            List<kotlin.reflect.y.internal.j0.f.b> e2;
            int u;
            List E0;
            List A0;
            int u2;
            ...
            if (i2 == 1) {
                ...
                e2 = u.m(b.m, new kotlin.reflect.y.internal.j0.f.b(k.r, c.f23233g.u(b.this.R0())));
            } else if (i2 == 3) {
                e2 = t.e(b.l);
            } else {
                if (i2 != 4) {
                ...
                e2 = u.m(b.m, new kotlin.reflect.y.internal.j0.f.b(k.f23199j, c.f23234h.u(b.this.R0())));
            }
            g0 b2 = b.this.o.b();
            u = v.u(e2, 10);
            ArrayList arrayList = new ArrayList(u);
            for (kotlin.reflect.y.internal.j0.f.b bVar : e2) {
                e a2 = x.a(b2, bVar);
                if (a2 != null) {
                    A0 = c0.A0(getParameters(), a2.h().getParameters().size());
                    u2 = v.u(A0, 10);
                    ...
                    arrayList.add(f0.g(a1.f24676g.h(), a2, arrayList2));
                } else {
    ...
    private static final void L0(ArrayList<e1> arrayList, b bVar, r1 r1Var, String str) {
        arrayList.add(kotlin.reflect.jvm.internal.impl.descriptors.p1.k0.S0(bVar, kotlin.reflect.jvm.internal.impl.descriptors.n1.g.f25179c.b(), false, r1Var, f.x(str), arrayList.size(), bVar.n));
    }
