...
public class e extends g0 implements kotlin.reflect.y.internal.j0.d.a.k0.a {
    public static final a.InterfaceC0406a<i1> J = new a();
    public static final a.InterfaceC0406a<Boolean> K = new b();
    private c L;
    private final boolean M;

    /* compiled from: JavaMethodDescriptor.java */
    /* loaded from: classes2.dex */
    static class a implements a.InterfaceC0406a<i1> {
        a() {
        }
    }
    ...
    /* compiled from: JavaMethodDescriptor.java */
    /* loaded from: classes2.dex */
    static class b implements a.InterfaceC0406a<Boolean> {
        b() {
        }
    }
    ...
    public g0 p1(w0 w0Var, w0 w0Var2, List<w0> list, List<? extends e1> list2, List<i1> list3, e0 e0Var, d0 d0Var, u uVar, Map<? extends a.InterfaceC0406a<?>, ?> map) {
        if (list == null) {
            v(9);
        }
        if (list2 == null) {
    ...
    public e y(e0 e0Var, List<e0> list, e0 e0Var2, Pair<a.InterfaceC0406a<?>, ?> pair) {
        if (list == null) {
            v(19);
        }
        if (e0Var2 == null) {
