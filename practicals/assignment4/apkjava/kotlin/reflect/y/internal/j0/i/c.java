...
public class c {
    ...
    public static class a extends f {
        ...
        public a(e eVar, z0 z0Var, boolean z) {
            super(eVar, null, g.f25179c.b(), true, b.a.DECLARATION, z0Var);
            if (eVar == null) {
                v(0);
            }
            if (z0Var == null) {
    ...
    public static w0 b(kotlin.reflect.jvm.internal.impl.descriptors.a aVar, e0 e0Var, g gVar) {
        ...
        return new f0(aVar, new kotlin.reflect.y.internal.j0.i.w.o.c(aVar, e0Var, null), gVar);
    }
    ...
    public static w0 c(e eVar, e0 e0Var, g gVar) {
        ...
        return new f0(eVar, new kotlin.reflect.y.internal.j0.i.w.o.b(eVar, e0Var, null), gVar);
    }
    ...
    public static y0 f(e eVar) {
        ...
        g.a aVar = g.f25179c;
        g0 m1 = g0.m1(eVar, aVar.b(), k.f23194e, b.a.SYNTHESIZED, eVar.t());
        g0 S0 = m1.S0(null, null, Collections.emptyList(), Collections.emptyList(), Collections.singletonList(new l0(m1, null, 0, aVar.b(), kotlin.reflect.y.internal.j0.f.f.x("value"), kotlin.reflect.y.internal.j0.i.t.a.f(eVar).W(), false, false, false, null, eVar.t())), eVar.s(), kotlin.reflect.jvm.internal.impl.descriptors.d0.FINAL, t.f25368e);
        if (S0 == null) {
            a(25);
        }
        return S0;
    ...
    public static y0 g(e eVar) {
        ...
        g0 S0 = g0.m1(eVar, g.f25179c.b(), k.f23193d, b.a.SYNTHESIZED, eVar.t()).S0(null, null, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), kotlin.reflect.y.internal.j0.i.t.a.f(eVar).l(r1.INVARIANT, eVar.s()), kotlin.reflect.jvm.internal.impl.descriptors.d0.FINAL, t.f25368e);
        if (S0 == null) {
            a(23);
        }
        return S0;
    ...
    public static boolean o(y yVar) {
        ...
        return yVar.getName().equals(k.f23194e) && n(yVar);
    }
    ...
    public static boolean p(y yVar) {
        ...
        return yVar.getName().equals(k.f23193d) && n(yVar);
    }
}
