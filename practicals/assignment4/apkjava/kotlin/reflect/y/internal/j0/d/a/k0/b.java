...
public class b extends f implements a {
    ...
    public b M0(m mVar, y yVar, b.a aVar, kotlin.reflect.y.internal.j0.f.f fVar, g gVar, z0 z0Var) {
        if (mVar == null) {
            v(7);
        }
        if (aVar == null) {
    ...
    public b y(e0 e0Var, List<e0> list, e0 e0Var2, Pair<a.InterfaceC0406a<?>, ?> pair) {
        ...
        w0 h2 = e0Var == null ? null : c.h(M0, e0Var, g.f25179c.b());
        w0 f0 = f0();
        j2 = u.j();
        M0.S0(h2, f0, j2, getTypeParameters(), h.a(list, f(), M0), e0Var2, j(), getVisibility());
        if (pair != null) {
            M0.V0(pair.c(), pair.d());
        }
        return M0;
