...
public abstract class KCallableImpl<R> implements KCallable<R>, KTypeParameterOwnerImpl {
    ...
    static final class b extends Lambda implements Function0<ArrayList<KParameter>> {
        ...
        /* loaded from: classes2.dex */
        public static final class C0315b extends Lambda implements Function0<q0> {
        ...
        public static final class c extends Lambda implements Function0<q0> {
            ...
            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ kotlin.reflect.jvm.internal.impl.descriptors.b f23050f;
        ...
        public final ArrayList<KParameter> invoke() {
            int i2;
            kotlin.reflect.jvm.internal.impl.descriptors.b F = this.f23047f.F();
            ...
            if (this.f23047f.E()) {
                ...
                w0 i4 = g0.i(F);
                if (i4 != null) {
                    arrayList.add(new KParameterImpl(this.f23047f, 0, KParameter.a.INSTANCE, new a(i4)));
                    i2 = 1;
                } else {
                    i2 = 0;
                }
                w0 m0 = F.m0();
                if (m0 != null) {
                    arrayList.add(new KParameterImpl(this.f23047f, i2, KParameter.a.EXTENSION_RECEIVER, new C0315b(m0)));
                    i2++;
                }
            }
            int size = F.f().size();
            while (i3 < size) {
                arrayList.add(new KParameterImpl(this.f23047f, i2, KParameter.a.VALUE, new c(F, i3)));
                i3++;
                i2++;
            }
            if (this.f23047f.D() && (F instanceof kotlin.reflect.y.internal.j0.d.a.k0.a) && arrayList.size() > 1) {
                y.y(arrayList, new d());
            }
    ...
    static final class c extends Lambda implements Function0<KTypeImpl> {
        ...
        public static final class a extends Lambda implements Function0<Type> {
            ...
            public final Type invoke() {
                Type y = this.f23053f.y();
                return y == null ? this.f23053f.z().getF23144c() : y;
            }
        }
    ...
    public KCallableImpl() {
        ...
        m.e(d2, "lazySoft { descriptor.computeAnnotations() }");
        this.f23042f = d2;
    ...
    public final Type y() {
        ...
        Object N = j.N(actualTypeArguments);
    ...
    public List<Annotation> getAnnotations() {
        List<Annotation> invoke = this.f23042f.invoke();
    ...
    public List<KParameter> getParameters() {
        ArrayList<KParameter> invoke = this.f23043g.invoke();
    ...
    public KType getReturnType() {
        KTypeImpl invoke = this.f23044h.invoke();
    ...
    public List<KTypeParameter> getTypeParameters() {
        List<KTypeParameterImpl> invoke = this.f23045i.invoke();
    ...
    public final R w(Map<KParameter, ? extends Object> map, Continuation<?> continuation) {
        m.f(map, "args");
        List<KParameter> parameters = getParameters();
