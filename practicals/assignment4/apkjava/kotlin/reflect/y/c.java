...
public final class c {
    public static final <T> Constructor<T> a(KFunction<? extends T> kFunction) {
        Caller<?> z;
        m.f(kFunction, "<this>");
        KCallableImpl<?> b2 = g0.b(kFunction);
        Object member = (b2 == null || (z = b2.z()) == null) ? null : z.getMember();
    ...
    public static final Field b(KProperty<?> kProperty) {
        m.f(kProperty, "<this>");
        KPropertyImpl<?> d2 = g0.d(kProperty);
        if (d2 != null) {
            return d2.K();
        }
        return null;
    ...
    public static final Method e(KMutableProperty<?> kMutableProperty) {
        m.f(kMutableProperty, "<this>");
        return d(kMutableProperty.getSetter());
    }

    public static final Type f(KType kType) {
        m.f(kType, "<this>");
        Type j2 = ((KTypeImpl) kType).j();
        return j2 == null ? w.f(kType) : j2;
    }
}
