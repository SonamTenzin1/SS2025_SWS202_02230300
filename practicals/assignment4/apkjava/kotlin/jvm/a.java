...
public final class a {
    public static final <T extends Annotation> KClass<? extends T> a(T t) {
        ...
        m.d(e2, "null cannot be cast to non-null type kotlin.reflect.KClass<out T of kotlin.jvm.JvmClassMappingKt.<get-annotationClass>>");
        return e2;
    }
    ...
    public static final <T> Class<T> c(KClass<T> kClass) {
        ...
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) kClass).a();
        if (!cls.isPrimitive()) {
            m.d(cls, "null cannot be cast to non-null type java.lang.Class<T of kotlin.jvm.JvmClassMappingKt.<get-javaObjectType>>");
            return cls;
        }
    ...
    public static final <T> Class<T> d(KClass<T> kClass) {
        ...
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) kClass).a();
        if (cls.isPrimitive()) {
            m.d(cls, "null cannot be cast to non-null type java.lang.Class<T of kotlin.jvm.JvmClassMappingKt.<get-javaPrimitiveType>>");
            return cls;
        }
        String name = cls.getName();
        switch (name.hashCode()) {
