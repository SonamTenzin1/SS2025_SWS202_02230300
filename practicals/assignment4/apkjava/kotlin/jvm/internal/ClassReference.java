...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    public static final a f22936f = new a(null);

    /* renamed from: g, reason: collision with root package name */
    private static final Map<Class<? extends Function<?>>, Integer> f22937g;

    /* renamed from: h, reason: collision with root package name */
    private static final HashMap<String, String> f22938h;

    /* renamed from: i, reason: collision with root package name */
    private static final HashMap<String, String> f22939i;

    /* renamed from: j, reason: collision with root package name */
    private static final HashMap<String, String> f22940j;

    /* renamed from: k, reason: collision with root package name */
    private static final Map<String, String> f22941k;
    ...
    public static final class a {
        ...
        public final String a(Class<?> cls) {
            ...
            if (!cls.isArray()) {
                String str3 = (String) ClassReference.f22940j.get(cls.getName());
                return str3 == null ? cls.getCanonicalName() : str3;
            }
            Class<?> componentType = cls.getComponentType();
            if (componentType.isPrimitive() && (str = (String) ClassReference.f22940j.get(componentType.getName())) != null) {
                str2 = str + "Array";
            }
            ...
            if (!cls.isAnonymousClass()) {
                if (cls.isLocalClass()) {
                    ...
                    if (enclosingMethod != null) {
                        m.e(simpleName, "name");
                        G02 = v.G0(simpleName, enclosingMethod.getName() + '$', null, 2, null);
                        if (G02 != null) {
                            return G02;
                        }
                    }
                    ...
                    if (enclosingConstructor == null) {
                        m.e(simpleName, "name");
                        F0 = v.F0(simpleName, '$', null, 2, null);
                        return F0;
                    }
                    m.e(simpleName, "name");
                    G0 = v.G0(simpleName, enclosingConstructor.getName() + '$', null, 2, null);
                    return G0;
                }
                if (!cls.isArray()) {
                    String str3 = (String) ClassReference.f22941k.get(cls.getName());
                    return str3 == null ? cls.getSimpleName() : str3;
                }
                Class<?> componentType = cls.getComponentType();
                if (componentType.isPrimitive() && (str = (String) ClassReference.f22941k.get(componentType.getName())) != null) {
                    str2 = str + "Array";
                }
                if (str2 == null) {
                    return "Array";
    ...
    static {
        ...
        String I02;
        int i2 = 0;
        m = u.m(Function0.class, Function1.class, Function2.class, Function3.class, Function4.class, Function5.class, Function6.class, Function7.class, Function8.class, Function9.class, Function10.class, Function11.class, Function12.class, Function13.class, Function14.class, Function15.class, Function16.class, Function17.class, Function18.class, Function19.class, Function20.class, Function21.class, Function22.class);
        ...
        for (Map.Entry<Class<? extends Function<?>>, Integer> entry : f22937g.entrySet()) {
            hashMap3.put(entry.getKey().getName(), "kotlin.Function" + entry.getValue().intValue());
        }
        f22940j = hashMap3;
        e2 = p0.e(hashMap3.size());
        LinkedHashMap linkedHashMap = new LinkedHashMap(e2);
        for (Map.Entry entry2 : hashMap3.entrySet()) {
            Object key = entry2.getKey();
            I0 = v.I0((String) entry2.getValue(), '.', null, 2, null);
            linkedHashMap.put(key, I0);
        }
        f22941k = linkedHashMap;
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof ClassReference) && m.a(kotlin.jvm.a.c(this), kotlin.jvm.a.c((KClass) other));
    }
