...
public abstract class AbstractCollection<E> implements Collection<E>, KMappedMarker {
    ...
    static final class a extends Lambda implements Function1<E, CharSequence> {
        ...
        final /* synthetic */ AbstractCollection<E> f25532f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(AbstractCollection<? extends E> abstractCollection) {
            super(1);
            this.f25532f = abstractCollection;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public final CharSequence invoke(E e2) {
            return e2 == this.f25532f ? "(this Collection)" : String.valueOf(e2);
        }
    }
    ...
    public String toString() {
        String e0;
        e0 = c0.e0(this, ", ", "[", "]", 0, null, new a(this), 24, null);
        return e0;
    }
    ...
    public <T> T[] toArray(T[] array) {
        ...
        m.d(tArr, "null cannot be cast to non-null type kotlin.Array<T of kotlin.collections.CollectionsKt__CollectionsJVMKt.copyToArrayImpl>");
        return tArr;
    }
}
