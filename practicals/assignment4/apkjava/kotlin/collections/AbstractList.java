...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    public class b implements Iterator<E>, KMappedMarker {
        ...
        protected final int getF25536f() {
            return this.f25536f;
        }
        ...
        public boolean hasNext() {
            return this.f25536f < AbstractList.this.size();
        }
    ...
    private class c extends AbstractList<E>.b implements ListIterator<E>, KMappedMarker {
        public c(int i2) {
            super();
            AbstractList.f25535f.b(i2, AbstractList.this.size());
            c(i2);
        }
        ...
        public E previous() {
            if (hasPrevious()) {
                AbstractList<E> abstractList = AbstractList.this;
                c(getF25536f() - 1);
                return abstractList.get(getF25536f());
            }
            throw new NoSuchElementException();
        }
    ...
    private static final class d<E> extends AbstractList<E> implements RandomAccess {
        ...
        private final AbstractList<E> f25539g;
        ...
        public d(AbstractList<? extends E> abstractList, int i2, int i3) {
            m.f(abstractList, "list");
            this.f25539g = abstractList;
            this.f25540h = i2;
            AbstractList.f25535f.c(i2, i3, abstractList.size());
            this.f25541i = i3 - i2;
        }
        ...
        public E get(int index) {
            AbstractList.f25535f.a(index, this.f25541i);
            return this.f25539g.get(this.f25540h + index);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof List) {
            return f25535f.d(this, (Collection) other);
        }
        return false;
    }
    ...
    public int lastIndexOf(E element) {
        ...
        while (listIterator.hasPrevious()) {
            if (m.a(listIterator.previous(), element)) {
