...
public class u extends t {
    ...
    public static boolean B(String str, String str2, int i2, boolean z) {
        ...
        return u(str, i2, str2, 0, str2.length(), z);
    }
    ...
    public static boolean t(CharSequence charSequence) {
        ...
        if (charSequence.length() != 0) {
            ...
            if (!(P instanceof Collection) || !((Collection) P).isEmpty()) {
                ...
                while (it.hasNext()) {
                    c2 = b.c(charSequence.charAt(((IntIterator) it).b()));
                    if (!c2) {
                        z = false;
                        break;
                    }
    ...
    public static /* synthetic */ boolean v(String str, int i2, String str2, int i3, int i4, boolean z, int i5, Object obj) {
        return u(str, i2, str2, i3, i4, (i5 & 16) != 0 ? false : z);
    }
