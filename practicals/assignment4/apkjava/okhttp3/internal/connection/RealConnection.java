        ...
        while (true) {
            ...
            if (code == 407) {
                ...
                if (authenticate != null) {
                    q = u.q("close", Response.header$default(build, "Connection", null, 2, null), true);
                    if (q) {
                        return authenticate;
                    }
