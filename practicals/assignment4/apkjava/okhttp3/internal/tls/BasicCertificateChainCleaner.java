...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    private final boolean verifySignature(X509Certificate toVerify, X509Certificate signingCert) {
        if (!m.a(toVerify.getIssuerDN(), signingCert.getSubjectDN())) {
            return false;
        }
        try {
        ...
        for (int i2 = 0; i2 < 9; i2++) {
            ...
            if (obj != null) {
                ...
                if (findByIssuerAndSignature != null) {
                    if (arrayList.size() > 1 || (!m.a(x509Certificate, findByIssuerAndSignature))) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BasicCertificateChainCleaner) && m.a(((BasicCertificateChainCleaner) other).trustRootIndex, this.trustRootIndex);
    }
