...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u000b\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\r\bÆ\u0002\u0018\u00002\u00020\u0001:\u0002\u001c\u001dB\t\b\u0002¢\u0006\u0004\b\u001a\u0010\u001bJ\u001b\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00040\u0002H\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u0015\u0010\b\u001a\u00020\u00032\u0006\u0010\u0007\u001a\u00020\u0003¢\u0006\u0004\b\b\u0010\tR%\u0010\n\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00040\u00028\u0006@\u0006¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\u0006R\u0016\u0010\r\u001a\u00020\u00048\u0002@\u0002X\u0082T¢\u0006\u0006\n\u0004\b\r\u0010\u000eR\u0016\u0010\u000f\u001a\u00020\u00048\u0002@\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u000f\u0010\u000eR\u001f\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00110\u00108\u0006@\u0006¢\u0006\f\n\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0014\u0010\u0015R\u0016\u0010\u0016\u001a\u00020\u00048\u0002@\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0016\u0010\u000eR\u0016\u0010\u0017\u001a\u00020\u00048\u0002@\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0017\u0010\u000eR\u0016\u0010\u0018\u001a\u00020\u00048\u0002@\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0018\u0010\u000eR\u0016\u0010\u0019\u001a\u00020\u00048\u0002@\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0019\u0010\u000e¨\u0006\u001e"}, d2 = {"Lokhttp3/internal/http2/Hpack;", HttpUrl.FRAGMENT_ENCODE_SET, HttpUrl.FRAGMENT_ENCODE_SET, "Lj/i;", HttpUrl.FRAGMENT_ENCODE_SET, "nameToFirstIndex", "()Ljava/util/Map;", "name", "checkLowercase", "(Lj/i;)Lj/i;", "NAME_TO_FIRST_INDEX", "Ljava/util/Map;", "getNAME_TO_FIRST_INDEX", "PREFIX_7_BITS", "I", "PREFIX_5_BITS", HttpUrl.FRAGMENT_ENCODE_SET, "Lokhttp3/internal/http2/Header;", "STATIC_HEADER_TABLE", "[Lokhttp3/internal/http2/Header;", "getSTATIC_HEADER_TABLE", "()[Lokhttp3/internal/http2/Header;", "SETTINGS_HEADER_TABLE_SIZE_LIMIT", "SETTINGS_HEADER_TABLE_SIZE", "PREFIX_4_BITS", "PREFIX_6_BITS", "<init>", "()V", "Reader", "Writer", "okhttp"}, k = 1, mv = {1, 4, 0})
...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        private final void clearDynamicTable() {
            kotlin.collections.m.m(this.dynamicTable, null, 0, 0, 6, null);
        ...
        */
        public final void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                Integer num = hpack.getNAME_TO_FIRST_INDEX().get(R);
                if (num != null) {
                    i3 = num.intValue() + 1;
                    if (2 <= i3 && 7 >= i3) {
                        if (m.a(hpack.getSTATIC_HEADER_TABLE()[i3 - 1].value, iVar)) {
                            i2 = i3;
                        } else if (m.a(hpack.getSTATIC_HEADER_TABLE()[i3].value, iVar)) {
                            i3++;
                            i2 = i3;
                        }
                        if (i3 == -1) {
                            ...
                            while (true) {
                                ...
                                m.c(header2);
                                if (m.a(header2.name, R)) {
                                    Header header3 = this.dynamicTable[i6];
                                    m.c(header3);
                                    if (m.a(header3.value, iVar)) {
                        ...
                        } else if (R.Q(Header.PSEUDO_PREFIX) && (!m.a(Header.TARGET_AUTHORITY, R))) {
                            writeInt(i2, 15, 0);
                            writeByteString(iVar);
                        } else {
                            writeInt(i2, 63, 64);
