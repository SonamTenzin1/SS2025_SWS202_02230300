    ...
    public final synchronized void connectionPreface() throws IOException {
        if (!this.closed) {
            if (this.client) {
                ...
                this.sink.U0(Http2.CONNECTION_PREFACE);
                this.sink.flush();
                return;
            }
            return;
