...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public static final class Companion {
            ...
            public final int schemeDelimiterOffset(String input, int pos, int limit) {
                ...
                char charAt = input.charAt(pos);
                if ((m.h(charAt, 97) < 0 || m.h(charAt, 122) > 0) && (m.h(charAt, 65) < 0 || m.h(charAt, 90) > 0)) {
                    return -1;
                }
                while (true) {
                    pos++;
        ...
        private final boolean isDotDot(String input) {
            ...
            q2 = u.q(input, ".%2e", true);
            if (q2) {
                return true;
            }
            q3 = u.q(input, "%2e%2e", true);
            return q3;
        }
        ...
        public final Builder encodedPath(String encodedPath) {
            ...
            E = u.E(encodedPath, "/", false, 2, null);
            if (E) {
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
            ...
            if (schemeDelimiterOffset != -1) {
                B = u.B(input, "https:", indexOfFirstNonAsciiWhitespace$default, true);
                if (B) {
                    this.scheme = BuildConfig.APTOIDE_WEB_SERVICES_SCHEME;
                    indexOfFirstNonAsciiWhitespace$default += 6;
                } else {
                    B2 = u.B(input, "http:", indexOfFirstNonAsciiWhitespace$default, true);
                    if (B2) {
                        this.scheme = "http";
        ...
        public final Builder scheme(String scheme) {
            ...
            boolean q2;
            m.f(scheme, "scheme");
            q = u.q(scheme, "http", true);
            if (q) {
                this.scheme = "http";
            } else {
                q2 = u.q(scheme, BuildConfig.APTOIDE_WEB_SERVICES_SCHEME, true);
                if (!q2) {
        ...
        */
        public String toString() {
            ...
            if (str2 != null) {
                m.c(str2);
                I = kotlin.text.v.I(str2, ':', false, 2, null);
                if (I) {
                    sb.append('[');
                    sb.append(this.host);
                    sb.append(']');
    ...
    public static final class Companion {
        ...
        */
                    ...
                    if (!z || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                        if (codePointAt == 43 && z3) {
                            ...
                            if (codePointAt >= 32 && codePointAt != 127 && (codePointAt < 128 || z4)) {
                                I = kotlin.text.v.I(str2, (char) codePointAt, false, 2, null);
                                if (!I) {
                                    if (codePointAt == 37) {
                                        if (z) {
                                            if (z2) {
                            ...
                            if (charset != null && !m.a(charset, StandardCharsets.UTF_8)) {
                                fVar2.T0(str, i4, Character.charCount(codePointAt) + i4, charset);
                            } else {
                            ...
                            while (!fVar2.R()) {
                                ...
                                fVar.writeByte(37);
                                fVar.writeByte(HttpUrl.HEX_DIGITS[(readByte >> 4) & 15]);
                                fVar.writeByte(HttpUrl.HEX_DIGITS[readByte & 15]);
                            }
                            i4 += Character.charCount(codePointAt);
                        }
                    }
        ...
        public final List<String> toQueryNamesAndValues$okhttp(String str) {
            ...
            int i2 = 0;
            while (i2 <= str.length()) {
                V = kotlin.text.v.V(str, '&', i2, false, 4, null);
                if (V == -1) {
                    V = str.length();
                }
                int i3 = V;
                V2 = kotlin.text.v.V(str, '=', i2, false, 4, null);
                if (V2 != -1 && V2 <= i3) {
                    String substring = str.substring(i2, V2);
                    m.e(substring, "(this as java.lang.Strin…ing(startIndex, endIndex)");
                    arrayList.add(substring);
                    String substring2 = str.substring(V2 + 1, i3);
    ...
    public final String encodedFragment() {
        ...
        V = kotlin.text.v.V(this.url, '#', 0, false, 6, null);
        int i2 = V + 1;
        String str = this.url;
        if (str == null) {
            throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
    ...
    public final String encodedPassword() {
        ...
        V = kotlin.text.v.V(this.url, ':', this.scheme.length() + 3, false, 4, null);
        int i2 = V + 1;
        V2 = kotlin.text.v.V(this.url, '@', 0, false, 6, null);
        String str = this.url;
        if (str == null) {
            throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
        }
    ...
    public final String encodedPath() {
        ...
        String substring = str2.substring(V, delimiterOffset);
        m.e(substring, "(this as java.lang.Strin…ing(startIndex, endIndex)");
        return substring;
    }
    ...
    public final Set<String> queryParameterNames() {
        ...
        k2 = l.k(0, this.queryNamesAndValues.size());
        j2 = l.j(k2, 2);
        int f22972g = j2.getF22972g();
        int f22973h = j2.getF22973h();
        int f22974i = j2.getF22974i();
