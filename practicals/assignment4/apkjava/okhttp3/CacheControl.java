...
public final class CacheControl {
    ...
    public static final class Companion {
        ...
        private final int indexOfElement(String str, String str2, int i2) {
            ...
            while (i2 < length) {
                I = v.I(str2, str.charAt(i2), false, 2, null);
                if (I) {
                    return i2;
                }
                i2++;
        ...
        */
        public final CacheControl parse(Headers headers) {
            ...
            while (i5 < size) {
                ...
                q = u.q(name, "Cache-Control", z2);
                if (!q) {
                    q2 = u.q(name, "Pragma", z2);
                    if (!q2) {
                        i2 = size;
                        i5++;
                        headers2 = headers;
                    ...
                    while (i3 < value.length()) {
                        int indexOfElement = indexOfElement(value, "=,;", i3);
                        String substring = value.substring(i3, indexOfElement);
                            ...
                            if (indexOfElement != value.length()) {
                                ...
                                if (value.charAt(indexOfElement) != ',' && value.charAt(indexOfElement) != ';') {
                                    ...
                                    if (indexOfNonWhitespace < value.length() && value.charAt(indexOfNonWhitespace) == '\"') {
                                        ...
                                        V = v.V(value, '\"', i11, false, 4, null);
                                        str = value.substring(i11, V);
                                    ...
                                    z2 = true;
                                    q3 = u.q("no-cache", obj, true);
                                    if (q3) {
                                        q4 = u.q("no-store", obj, true);
                                        if (q4) {
                                            z5 = true;
                                        } else {
                                            q5 = u.q("max-age", obj, true);
                                            if (q5) {
                                                i6 = Util.toNonNegativeInt(str, -1);
                                            } else {
                                                q6 = u.q("s-maxage", obj, true);
                                                if (q6) {
                                                    i7 = Util.toNonNegativeInt(str, -1);
                                                } else {
                                                    q7 = u.q("private", obj, true);
                                                    if (q7) {
                                                        z6 = true;
                                                    } else {
                                                        q8 = u.q("public", obj, true);
                                                        if (q8) {
                                                            z7 = true;
                                                        } else {
                                                            q9 = u.q("must-revalidate", obj, true);
                                                            if (q9) {
                                                                z8 = true;
                                                            } else {
                                                                q10 = u.q("max-stale", obj, true);
                                                                if (q10) {
                                                                    i8 = Util.toNonNegativeInt(str, Integer.MAX_VALUE);
                                                                } else {
                                                                    q11 = u.q("min-fresh", obj, true);
                                                                    if (q11) {
                                                                        i9 = Util.toNonNegativeInt(str, -1);
                                                                    } else {
                                                                        q12 = u.q("only-if-cached", obj, true);
                                                                        if (q12) {
                                                                            z9 = true;
                                                                        } else {
                                                                            q13 = u.q("no-transform", obj, true);
                                                                            if (q13) {
                                                                                z10 = true;
                                                                            } else {
                                                                                q14 = u.q("immutable", obj, true);
                                                                                if (q14) {
                                                                                    z11 = true;
                                                                                }
                                                                            }
            ...
            return new CacheControl(z4, z5, i6, i7, z6, z7, z8, i8, i9, z9, z10, z11, !z3 ? null : str2, null);
        }
