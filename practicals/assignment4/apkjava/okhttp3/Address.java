...
public final class Address {
    ...
    public final List<ConnectionSpec> m377deprecated_connectionSpecs() {
    ...
    public final List<Protocol> m380deprecated_protocols() {
    ...
    public boolean equals(Object other) {
        if (other instanceof Address) {
            ...
            if (m.a(this.url, address.url) && equalsNonHost$okhttp(address)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean equalsNonHost$okhttp(Address that) {
        m.f(that, "that");
        return m.a(this.dns, that.dns) && m.a(this.proxyAuthenticator, that.proxyAuthenticator) && m.a(this.protocols, that.protocols) && m.a(this.connectionSpecs, that.connectionSpecs) && m.a(this.proxySelector, that.proxySelector) && m.a(this.proxy, that.proxy) && m.a(this.sslSocketFactory, that.sslSocketFactory) && m.a(this.hostnameVerifier, that.hostnameVerifier) && m.a(this.certificatePinner, that.certificatePinner) && this.url.port() == that.url.port();
    }
