...
class u0 {
    ...
    public u0(Context context) {
        ...
        this.f657b = inflate;
        this.f658c = (TextView) inflate.findViewById(c.a.f.s);
    ...
    private void a(View view, int i2, int i3, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        b2.getWindowVisibleDisplayFrame(this.f660e);
        ...
        b2.getLocationOnScreen(this.f662g);
        ...
        this.f657b.measure(makeMeasureSpec, makeMeasureSpec);
