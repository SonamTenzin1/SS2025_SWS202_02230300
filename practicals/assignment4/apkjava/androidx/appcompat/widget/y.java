...
public class y {
    ...
    private static final int[] f665b = new int[0];

    /* renamed from: c, reason: collision with root package name */
    public static final Rect f666c = new Rect();

    /* renamed from: d, reason: collision with root package name */
    private static Class<?> f667d;

    static {
        if (Build.VERSION.SDK_INT >= 18) {
            try {
                f667d = Class.forName("android.graphics.Insets");
    ...
    public static Rect d(Drawable drawable) {
        ...
        if (f667d != null) {
            try {
                ...
                if (invoke != null) {
                    Rect rect2 = new Rect();
                    for (Field field : f667d.getFields()) {
