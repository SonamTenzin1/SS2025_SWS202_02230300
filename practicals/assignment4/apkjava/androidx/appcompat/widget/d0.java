...
public class d0 implements androidx.appcompat.view.menu.p {
    ...
    private int p() {
        ...
        if (i8 == -2) {
            ...
            int i10 = this.f504i.getResources().getDisplayMetrics().widthPixels;
            Rect rect3 = this.K;
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i10 - (rect3.left + rect3.right), 1073741824);
        }
        int d2 = this.f506k.d(makeMeasureSpec, 0, -1, t - i2, -1);
        if (d2 > 0) {
            i2 += i3 + this.f506k.getPaddingTop() + this.f506k.getPaddingBottom();
        }
        return d2 + i2;
    }
