...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        this.f362j = obtainStyledAttributes.getDrawable(c.a.j.f2756b);
        this.f363k = obtainStyledAttributes.getDrawable(c.a.j.f2758d);
        this.o = obtainStyledAttributes.getDimensionPixelSize(c.a.j.f2764j, -1);
        boolean z = true;
        if (getId() == c.a.f.H) {
            this.m = true;
            this.l = obtainStyledAttributes.getDrawable(c.a.j.f2757c);
        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (!b(this.f360h)) {
            ...
            a = !b(this.f361i) ? a(this.f361i) : 0;
        }
        setMeasuredDimension(getMeasuredWidth(), Math.min(a + a(this.f359g), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i3) : Integer.MAX_VALUE));
    }
