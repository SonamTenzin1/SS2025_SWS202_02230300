...
class k0 extends c.j.a.c implements View.OnClickListener {
    ...
    private Drawable f() {
        Drawable d2 = d(this.f567j.getSearchActivity());
    ...
    private Drawable g(Uri uri) {
        try {
            ...
            InputStream openInputStream = this.f568k.getContentResolver().openInputStream(uri);
    ...
    private Drawable i(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.f568k.getPackageName() + "/" + parseInt;
            Drawable a2 = a(str2);
            if (a2 != null) {
                return a2;
            }
            Drawable f2 = androidx.core.content.a.f(this.f568k, parseInt);
            q(str2, f2);
            return f2;
        } catch (Resources.NotFoundException unused) {
    ...
    public CharSequence convertToString(Cursor cursor) {
        ...
        if (this.f567j.shouldRewriteQueryFromData() && (e3 = e(cursor, "suggest_intent_data")) != null) {
            return e3;
        }
        if (!this.f567j.shouldRewriteQueryFromText() || (e2 = e(cursor, "suggest_text_1")) == null) {
            return null;
        }
        return e2;
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        ...
        if (this.f566i.getVisibility() == 0 && this.f566i.getWindowVisibility() == 0) {
            try {
                Cursor l = l(this.f567j, charSequence2, 50);
                if (l != null) {
                    l.getCount();
                    return l;
                }
