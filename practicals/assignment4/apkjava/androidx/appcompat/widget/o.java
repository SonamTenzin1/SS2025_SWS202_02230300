...
class o {
    ...
    private final ProgressBar f592b;

    /* renamed from: c, reason: collision with root package name */
    private Bitmap f593c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public o(ProgressBar progressBar) {
        this.f592b = progressBar;
    }
    ...
    public void c(AttributeSet attributeSet, int i2) {
        q0 v = q0.v(this.f592b.getContext(), attributeSet, a, i2, 0);
        Drawable h2 = v.h(0);
        if (h2 != null) {
            this.f592b.setIndeterminateDrawable(e(h2));
        }
        Drawable h3 = v.h(1);
        if (h3 != null) {
            this.f592b.setProgressDrawable(d(h3, false));
        }
        v.w();
    }
}
