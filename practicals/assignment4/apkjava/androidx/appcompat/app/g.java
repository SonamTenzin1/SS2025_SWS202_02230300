...
public class g extends androidx.appcompat.app.f implements g.a, LayoutInflater.Factory2 {
    ...
    /* loaded from: classes.dex */
    public class C0010g extends androidx.core.view.a0 {
        C0010g() {
        }
    ...
    public static final class t {
        ...
        void d(Context context) {
            ...
            if (i3 != 0) {
                ...
                newTheme.applyStyle(c.a.i.f2753c, true);
            }
            c.a.o.d dVar = new c.a.o.d(context, 0);
            dVar.getTheme().setTo(newTheme);
            this.l = dVar;
            TypedArray obtainStyledAttributes = dVar.obtainStyledAttributes(c.a.j.z0);
            this.f180b = obtainStyledAttributes.getResourceId(c.a.j.C0, 0);
            this.f184f = obtainStyledAttributes.getResourceId(c.a.j.B0, 0);
    ...
    private void C0(t tVar, KeyEvent keyEvent) {
        ...
        if (k0 != null && !k0.onMenuOpened(tVar.a, tVar.f188j)) {
            T(tVar, true);
            return;
        }
        ...
        if (windowManager != null && F0(tVar, keyEvent)) {
            ...
            i2 = -2;
            tVar.n = false;
            WindowManager.LayoutParams layoutParams22 = new WindowManager.LayoutParams(i2, -2, tVar.f182d, tVar.f183e, 1002, 8519680, -3);
            layoutParams22.gravity = tVar.f181c;
            layoutParams22.windowAnimations = tVar.f184f;
            windowManager.addView(tVar.f185g, layoutParams22);
            tVar.o = true;
        }
    }
    ...
    private boolean F0(t tVar, KeyEvent keyEvent) {
        ...
        Window.Callback k0 = k0();
        if (k0 != null) {
            tVar.f187i = k0.onCreatePanelView(tVar.a);
        }
        int i2 = tVar.a;
        ...
        if (tVar.f187i == null && (!z || !(D0() instanceof androidx.appcompat.app.l))) {
            ...
            if (gVar == null || tVar.r) {
                ...
                tVar.f188j.h0();
                if (!k0.onCreatePanelMenu(tVar.a, tVar.f188j)) {
                    tVar.c(null);
            ...
            if (!k0.onPreparePanel(0, tVar.f187i, tVar.f188j)) {
    ...
    private void G0(boolean z) {
        ...
        if (wVar != null && wVar.d() && (!ViewConfiguration.get(this.p).hasPermanentMenuKey() || this.w.e())) {
            ...
            if (this.w.b() && z) {
                ...
                k0.onPanelClosed(108, i0(0, true).f188j);
                return;
            }
            if (k0 == null || this.X) {
                return;
            ...
            t i0 = i0(0, true);
            androidx.appcompat.view.menu.g gVar = i0.f188j;
            if (gVar == null || i0.r || !k0.onPreparePanel(0, i0.f187i, gVar)) {
                return;
            }
            k0.onMenuOpened(108, i0.f188j);
            this.w.g();
            return;
        }
        t i02 = i0(0, true);
    ...
    */
    private boolean N0(int i2, boolean z) {
        boolean z2;
        Configuration U = U(this.p, i2, null);
        boolean q0 = q0();
        int i3 = this.p.getResources().getConfiguration().uiMode & 48;
        int i4 = U.uiMode & 48;
        boolean z3 = true;
        if (i3 != i4 && z && !q0 && this.U && (l || this.V)) {
            Object obj = this.o;
        ...
        if (z) {
            ...
            if (obj instanceof Activity) {
                ...
                if (activity instanceof androidx.lifecycle.k) {
                    if (((androidx.lifecycle.k) activity).getLifecycle().b().g(g.c.STARTED)) {
    ...
    private void Q0(View view) {
        ...
        if ((androidx.core.view.u.H(view) & 8192) != 0) {
            d2 = androidx.core.content.a.d(this.p, c.a.c.f2695b);
        } else {
            d2 = androidx.core.content.a.d(this.p, c.a.c.a);
        }
    ...
    private ViewGroup V() {
        ...
        if (obtainStyledAttributes.hasValue(i2)) {
            ...
            if (!this.P) {
                if (this.O) {
                    viewGroup = (ViewGroup) from.inflate(c.a.g.f2736f, (ViewGroup) null);
                    this.M = false;
                    this.L = false;
                } else if (this.L) {
                    TypedValue typedValue = new TypedValue();
    ...
    private boolean o0(t tVar) {
        ...
        if ((i2 == 0 || i2 == 108) && this.w != null) {
            ...
            if (typedValue.resourceId != 0) {
                ...
                theme2.resolveAttribute(c.a.a.f2690g, typedValue, true);
            } else {
                ...
                if (this.A == null) {
                    if (this.O) {
                        ...
                        if (typedValue.resourceId != 0) {
                            ...
                            context = new c.a.o.d(this.p, 0);
                            context.getTheme().setTo(newTheme);
                        } else {
                            context = this.p;
                        }
                        this.A = new ActionBarContextView(context);
                        PopupWindow popupWindow = new PopupWindow(context, (AttributeSet) null, c.a.a.f2692i);
                        this.B = popupWindow;
                        androidx.core.widget.j.b(popupWindow, 2);
                        this.B.setContentView(this.A);
                        this.B.setWidth(-1);
                        context.getTheme().resolveAttribute(c.a.a.f2685b, typedValue, true);
                ...
                if (this.A != null) {
                    ...
                    if (aVar.b(eVar3, eVar3.e())) {
                        ...
                        if (I0()) {
                            ...
                            y a2 = androidx.core.view.u.c(this.A).a(1.0f);
                            this.D = a2;
                            a2.f(new C0010g());
                        } else {
