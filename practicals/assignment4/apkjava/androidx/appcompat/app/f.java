...
public abstract class f {
    ...
    private static int f163f = -100;

    /* renamed from: g, reason: collision with root package name */
    private static final c.e.b<WeakReference<f>> f164g = new c.e.b<>();

    /* renamed from: h, reason: collision with root package name */
    private static final Object f165h = new Object();
    ...
    private static void B(f fVar) {
        synchronized (f165h) {
            Iterator<WeakReference<f>> it = f164g.iterator();
            while (it.hasNext()) {
                f fVar2 = it.next().get();
    ...
    public static void c(f fVar) {
        synchronized (f165h) {
            B(fVar);
            f164g.add(new WeakReference<>(fVar));
        }
    }
