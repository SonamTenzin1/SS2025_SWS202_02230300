...
public class c extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private androidx.lifecycle.r<androidx.lifecycle.k> mObserver;
    ...
    /* compiled from: DialogFragment.java */
    /* loaded from: classes.dex */
    class d implements androidx.lifecycle.r<androidx.lifecycle.k> {
        d() {
        }
    ...
    class e extends f {
        ...
        public View c(int i2) {
            View onFindViewById = c.this.onFindViewById(i2);
        ...
        @Override // androidx.fragment.app.f
        public boolean d() {
            return c.this.onHasView() || this.a.d();
        }
    }
    ...
    public c() {
        ...
        this.mOnDismissListener = new DialogInterfaceOnDismissListenerC0036c();
        this.mStyle = 0;
        this.mTheme = 0;
