...
public abstract class b extends View {
    ...
    private int g(String str) {
        ...
        return i2 == 0 ? this.f742h.getResources().getIdentifier(str, DeepLinkIntentReceiver.DeepLinksKeys.ID, this.f742h.getPackageName()) : i2;
    }
    ...
    protected void e(ConstraintLayout constraintLayout) {
        ...
        for (int i2 = 0; i2 < this.f741g; i2++) {
            View h2 = constraintLayout.h(this.f740f[i2]);
            if (h2 != null) {
    ...
    public void m(ConstraintLayout constraintLayout) {
        ...
        for (int i2 = 0; i2 < this.f741g; i2++) {
            ...
            if (h2 != null) {
                this.f743i.a(constraintLayout.i(h2));
            }
        }
