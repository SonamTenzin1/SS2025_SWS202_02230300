...
public class e implements androidx.work.impl.b {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (intent != null) {
                ...
                PowerManager.WakeLock b2 = androidx.work.impl.utils.j.b(e.this.f2368g, String.format("%s (%s)", action, Integer.valueOf(intExtra)));
                try {
                    ...
                    try {
                        ...
                        n.c().a(e.f2367f, String.format("Releasing operation wake lock (%s) %s", action, b2), new Throwable[0]);
                        b2.release();
                        e eVar4 = e.this;
                        eVar4.k(new d(eVar4));
                        throw th2;
    ...
    private void l() {
        b();
        PowerManager.WakeLock b2 = androidx.work.impl.utils.j.b(this.f2368g, "ProcessCommand");
        try {
            b2.acquire();
