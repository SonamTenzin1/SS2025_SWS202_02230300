...
public class e extends c<androidx.work.impl.m.b> {
    ...
    private static final String f2489e = n.f("NetworkMeteredCtrlr");
    ...
    public boolean c(androidx.work.impl.m.b bVar) {
        ...
        n.c().a(f2489e, "Metered network constraint is not supported before API 26, only checking for connected state.", new Throwable[0]);
        return !bVar.a();
    }
}
