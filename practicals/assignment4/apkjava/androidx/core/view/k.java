...
public class k {
    ...
    private boolean h(int i2, int i3, int i4, int i5, int[] iArr, int i6, int[] iArr2) {
        ...
        x.d(i7, this.f1051c, i2, i3, i4, i5, i6, iArr3);
        if (iArr != null) {
            this.f1051c.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i8;
            iArr[1] = iArr[1] - i9;
    ...
    public boolean a(float f2, float f3, boolean z) {
        ...
        return x.a(i2, this.f1051c, f2, f3, z);
    }
    ...
    public boolean b(float f2, float f3) {
        ...
        return x.b(i2, this.f1051c, f2, f3);
    }
    ...
    public boolean d(int i2, int i3, int[] iArr, int[] iArr2, int i4) {
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        x.c(i5, this.f1051c, i2, i3, iArr, i4);
        if (iArr2 != null) {
            this.f1051c.getLocationInWindow(iArr2);
            iArr2[0] = iArr2[0] - i6;
            iArr2[1] = iArr2[1] - i7;
