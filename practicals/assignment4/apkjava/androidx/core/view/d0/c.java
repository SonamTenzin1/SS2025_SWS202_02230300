...
public class c {
    ...
    public static class C0025c {
        ...
        public static C0025c f(int i2, int i3, int i4, int i5, boolean z, boolean z2) {
            ...
            if (i6 >= 19) {
                return new C0025c(AccessibilityNodeInfo.CollectionItemInfo.obtain(i2, i3, i4, i5, z));
            }
            return new C0025c(null);
        }
    ...
    public boolean K() {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f1032b.isShowingHintText();
        }
        return k(4);
    }
