...
public class RecyclerView extends ViewGroup implements ScrollingView, androidx.core.view.j {
    ...
    public class b0 implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                int i4 = currX - this.f1921f;
                int i5 = currY - this.f1922g;
                this.f1921f = currX;
                this.f1922g = currY;
                RecyclerView recyclerView2 = RecyclerView.this;
    ...
    public static abstract class o {
        ...
        */
        public static int getChildMeasureSpec(int i2, int i3, int i4, boolean z) {
            ...
            if (!z) {
                if (i4 < 0) {
                    if (i4 != -1) {
                        i6 = i4 == -2 ? Integer.MIN_VALUE : 1073741824;
                        i4 = 0;
                    }
                    i4 = max;
                }
        ...
        public static d getProperties(Context context, AttributeSet attributeSet, int i2, int i3) {
            d dVar = new d();
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c.t.c.f3462f, i2, i3);
            dVar.a = obtainStyledAttributes.getInt(c.t.c.f3463g, 1);
            dVar.f1930b = obtainStyledAttributes.getInt(c.t.c.q, 1);
            dVar.f1931c = obtainStyledAttributes.getBoolean(c.t.c.p, false);
            dVar.f1932d = obtainStyledAttributes.getBoolean(c.t.c.r, false);
        ...
        */
        ...
        public void onInitializeAccessibilityNodeInfoForItem(v vVar, z zVar, View view, androidx.core.view.d0.c cVar) {
            cVar.b0(c.C0025c.f(canScrollVertically() ? getPosition(view) : 0, 1, canScrollHorizontally() ? getPosition(view) : 0, 1, false, false));
        }
    ...
    public static class u {
        ...
        void d(int i2, long j2) {
            a g2 = g(i2);
            g2.f1939d = j(g2.f1939d, j2);
        }

        void e(int i2, long j2) {
            a g2 = g(i2);
            g2.f1938c = j(g2.f1938c, j2);
        }
    ...
    public final class v {
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public c0 I(int i2, boolean z, long j2) {
            c0 c0Var;
            boolean z2;
            c0 c0Var2;
            boolean z3;
            ...
            if (i2 >= 0 && i2 < RecyclerView.this.mState.b()) {
                if (RecyclerView.this.mState.e()) {
                    ...
                    if (c0Var != null) {
                        z2 = true;
                        if (c0Var == null && (c0Var = m(i2, z)) != null) {
                            if (L(c0Var)) {
                                if (!z) {
                                    c0Var.addFlags(4);
                                    if (c0Var.isScrap()) {
                        ...
                        if (c0Var == null) {
                            ...
                            if (m >= 0 && m < RecyclerView.this.mAdapter.getItemCount()) {
                                int itemViewType = RecyclerView.this.mAdapter.getItemViewType(m);
                                if (RecyclerView.this.mAdapter.hasStableIds() && (c0Var = l(RecyclerView.this.mAdapter.getItemId(m), itemViewType, z)) != null) {
                                    c0Var.mPosition = m;
                                    z2 = true;
                                }
                                if (c0Var == null && this.f1946h != null) {
                                    throw null;
                                }
                                if (c0Var == null) {
                                    c0 f2 = i().f(itemViewType);
                                    if (f2 != null) {
                                        f2.resetInternal();
                                ...
                                if (c0Var == null) {
                                    ...
                                    z3 = z2;
                                    if (z3 && !RecyclerView.this.mState.e() && c0Var2.hasAnyOfTheFlags(8192)) {
                                        c0Var2.setFlags(0, 8192);
                                        if (RecyclerView.this.mState.f1963k) {
                                            int buildAdapterChangeFlagsForAnimations = l.buildAdapterChangeFlagsForAnimations(c0Var2) | l.FLAG_APPEARED_IN_PRE_LAYOUT;
                                            RecyclerView recyclerView2 = RecyclerView.this;
                                            RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(c0Var2, recyclerView2.mItemAnimator.recordPreLayoutInformation(recyclerView2.mState, c0Var2, buildAdapterChangeFlagsForAnimations, c0Var2.getUnmodifiedPayloads()));
                                        }
                                    }
                                    if (!RecyclerView.this.mState.e() && c0Var2.isBound()) {
                                        c0Var2.mPreLayoutPosition = i2;
                                    } else if (c0Var2.isBound() || c0Var2.needsUpdate() || c0Var2.isInvalid()) {
                                        H = H(c0Var2, RecyclerView.this.mAdapterHelper.m(i2), i2, j2);
                                        layoutParams = c0Var2.itemView.getLayoutParams();
                                        if (layoutParams != null) {
                                            pVar = (p) RecyclerView.this.generateDefaultLayoutParams();
                                            c0Var2.itemView.setLayoutParams(pVar);
                                ...
                                throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + i2 + "(offset:" + m + ").state:" + RecyclerView.this.mState.b() + RecyclerView.this.exceptionLabel());
                            }
                        }
                        c0Var2 = c0Var;
                        z3 = z2;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState == 1) {
                ...
                iArr3[0] = 0;
                iArr3[1] = 0;
                if (dispatchNestedPreScroll(canScrollHorizontally != 0 ? i5 : 0, canScrollVertically ? i6 : 0, iArr3, this.mScrollOffset, 0)) {
                ...
                if (scrollByInternal(canScrollHorizontally != 0 ? i5 : 0, canScrollVertically ? i8 : 0, motionEvent)) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
                androidx.recyclerview.widget.h hVar = this.mGapWorker;
                if (hVar != null && (i5 != 0 || i8 != 0)) {
                    hVar.f(this, i5, i8);
                }
            }
        } else if (actionMasked == 3) {
    ...
    void viewRangeUpdate(int i2, int i3, Object obj) {
        ...
        for (int i6 = 0; i6 < j2; i6++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && (i4 = childViewHolderInt.mPosition) >= i2 && i4 < i5) {
                ...
                ((p) i7.getLayoutParams()).f1934c = true;
            }
        }
    ...
    */
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i2) {
        ...
        String string = obtainStyledAttributes.getString(c.t.c.o);
        if (obtainStyledAttributes.getInt(c.t.c.f3465i, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(c.t.c.f3464h, true);
        boolean z3 = obtainStyledAttributes.getBoolean(c.t.c.f3466j, false);
        this.mEnableFastScroller = z3;
        if (z3) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(c.t.c.m), obtainStyledAttributes.getDrawable(c.t.c.n), (StateListDrawable) obtainStyledAttributes.getDrawable(c.t.c.f3467k), obtainStyledAttributes.getDrawable(c.t.c.l));
        }
        obtainStyledAttributes.recycle();
