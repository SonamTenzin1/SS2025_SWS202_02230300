...
public final class a {
    ...
    /* compiled from: CircularRevealCompat.java */
    /* renamed from: e.e.b.c.p.a$a, reason: collision with other inner class name */
    /* loaded from: classes2.dex */
    ...
    public static Animator a(d dVar, float f2, float f3, float f4) {
        ...
        if (revealInfo != null) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal((View) dVar, (int) f2, (int) f3, revealInfo.f21070c, f4);
