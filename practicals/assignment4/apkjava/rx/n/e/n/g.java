...
public final class g<T> implements Queue<T> {
    ...
    private T t(AtomicReferenceArray<Object> atomicReferenceArray, long j2, int i2) {
        ...
        x(atomicReferenceArray, g2, null);
        w(j2 + 1);
        return t;
    }
    ...
    public boolean offer(T t) {
        ...
        int g2 = g(i2, i3);
        if (i2 < this.f26805j) {
            return A(atomicReferenceArray, t, i2, g2);
        }
        long j2 = this.f26804i + i2;
        ...
        v(atomicReferenceArray, i2, g2, t, i3);
        return true;
    }
    ...
    public T peek() {
        ...
        return t == f26802g ? s(q(atomicReferenceArray), h2, i2) : t;
    }
    ...
    public boolean u(T t, T t2) {
        ...
        if (o(atomicReferenceArray, g(j2, i2)) == null) {
            int g2 = g(r, i2);
            x(atomicReferenceArray, g2 + 1, t2);
            x(atomicReferenceArray, g2, t);
            z(j2);
            return true;
        }
        AtomicReferenceArray<Object> atomicReferenceArray2 = new AtomicReferenceArray<>(atomicReferenceArray.length());
        this.l = atomicReferenceArray2;
        int g3 = g(r, i2);
        x(atomicReferenceArray2, g3 + 1, t2);
        x(atomicReferenceArray2, g3, t);
        y(atomicReferenceArray, atomicReferenceArray2);
        x(atomicReferenceArray, g3, f26802g);
        z(j2);
        return true;
    }
