...
public final class SendMagicLinkView extends FrameLayout {
    ...
    public static abstract class State {
        ...
        public static final /* data */ class Error extends State {
            ...
            public boolean equals(Object other) {
                ...
                return m.a(this.message, error.message) && this.isTextFieldError == error.isTextFieldError;
            }
    ...
    public final e<String> getMagicLinkSubmit() {
        ...
        m.e(X, "clicks(send_magic_link_b…{ email.text.toString() }");
        return X;
    }
    ...
    public final e<Void> getSecureLoginTextClick() {
        ...
        m.e(a, "clicks(login_benefits_textview)");
        return a;
    }
    ...
    public final void setState(State state) {
        m.f(state, "state");
        if (m.a(state, State.Initial.INSTANCE)) {
            setInitialState();
