...
public abstract class FilterModel extends t<CardHolder> {
    ...
    public static final class CardHolder extends BaseViewHolder {
        static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {g0.h(new y(CardHolder.class, "button", "getButton()Landroid/widget/CheckedTextView;", 0))};
    ...
    public void bind(CardHolder holder) {
        ...
        if (filter != null) {
            ...
            if (num != null) {
                holder.getButton().setTextColor(androidx.core.content.a.e(holder.getItemView().getContext(), num.intValue()));
            }
