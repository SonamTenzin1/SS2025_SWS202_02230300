...
public final class DownloadProgressView extends FrameLayout {
    ...
    public static final void m1setupClickListeners$lambda0(DownloadProgressView downloadProgressView, View view) {
        m.f(downloadProgressView, "this$0");
    ...
    public final e<DownloadEventListener.Action> events() {
        ...
        m.e(l, "create(DownloadProgressViewEventOnSubscribe(this))");
        return l;
    }
    ...
    public final void setProgress(int progress) {
        if (m.a(this.stateMachine.b(), State.Queue.INSTANCE) || m.a(this.stateMachine.b(), State.Canceled.INSTANCE)) {
            return;
        }
        this.currentProgress = Math.min(Math.max(progress, 0), 100);
        if (m.a(this.stateMachine.b(), State.InProgress.INSTANCE) || m.a(this.stateMachine.b(), State.InitialPaused.INSTANCE)) {
