...
public class FragmentResultNavigator implements FragmentNavigator {
    ...
    public String navigateTo(Fragment fragment, boolean z) {
        u c2;
        String num = Integer.toString(this.fragmentManager.o0());
        u m = this.fragmentManager.m();
        int i2 = this.enterAnimation;
        int i3 = this.exitAnimation;
        u g2 = m.s(i2, i3, i2, i3).g(num);
        if (z) {
            c2 = g2.r(this.containerId, fragment, num);
        } else {
            c2 = g2.c(this.containerId, fragment, num);
        }
        c2.i();
        return num;
    }
    ...
    public void navigateToWithoutBackSave(Fragment fragment, boolean z) {
        ...
        u s = m.s(i2, i3, i2, i3);
        if (z) {
            b2 = s.q(this.containerId, fragment);
        } else {
            b2 = s.b(this.containerId, fragment);
        }
        b2.i();
    }
    ...
    public Fragment peekLast() {
        ...
        return this.fragmentManager.j0(this.fragmentManager.n0(r0.o0() - 1).getName());
    }
