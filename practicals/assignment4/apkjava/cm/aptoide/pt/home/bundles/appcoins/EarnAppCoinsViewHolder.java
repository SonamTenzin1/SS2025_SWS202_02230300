...
public final class EarnAppCoinsViewHolder extends AppBundleViewHolder {
    ...
    public EarnAppCoinsViewHolder(View view, DecimalFormat decimalFormat, rx.s.b<HomeEvent> bVar) {
        super(view);
        m.f(view, "view");
        m.f(decimalFormat, "decimalFormatter");
    ...
    public static final void m167setBundle$lambda0(EarnAppCoinsViewHolder earnAppCoinsViewHolder, HomeBundle homeBundle, View view) {
        m.f(earnAppCoinsViewHolder, "this$0");
    ...
    public static final void m168setBundle$lambda1(EarnAppCoinsViewHolder earnAppCoinsViewHolder, HomeBundle homeBundle, View view) {
        m.f(earnAppCoinsViewHolder, "this$0");
        ...
        if (homeBundle instanceof AppBundle) {
            ...
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.appcoins.b
                ...
                public final void onClick(View view) {
                    EarnAppCoinsViewHolder.m167setBundle$lambda0(EarnAppCoinsViewHolder.this, homeBundle, view);
                }
            });
            ((Button) this.itemView.findViewById(R.id.see_more_btn)).setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.appcoins.c
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    EarnAppCoinsViewHolder.m168setBundle$lambda1(EarnAppCoinsViewHolder.this, homeBundle, view);
                }
            });
            return;
        }
