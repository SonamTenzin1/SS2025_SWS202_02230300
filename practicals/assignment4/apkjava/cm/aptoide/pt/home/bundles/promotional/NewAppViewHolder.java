...
public final class NewAppViewHolder extends AppBundleViewHolder {
    ...
    public static final void m176setBundle$lambda2$lambda0(NewAppViewHolder newAppViewHolder, HomeBundle homeBundle, View view) {
        m.f(newAppViewHolder, "this$0");
    ...
    public static final void m177setBundle$lambda2$lambda1(NewAppViewHolder newAppViewHolder, HomeBundle homeBundle, View view) {
        m.f(newAppViewHolder, "this$0");
        newAppViewHolder.fireAppClickEvent((PromotionalBundle) homeBundle);
    }
            ...
            if (bonusPromotionalBundle != null) {
                ...
                ((Button) this.itemView.findViewById(R.id.action_button)).setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.promotional.g
                    ...
                    public final void onClick(View view2) {
                        NewAppViewHolder.m176setBundle$lambda2$lambda0(NewAppViewHolder.this, homeBundle, view2);
                    }
                });
                this.itemView.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.promotional.f
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        NewAppViewHolder.m177setBundle$lambda2$lambda1(NewAppViewHolder.this, homeBundle, view2);
                    }
                });
