...
public final class EarnAppCoinsItemViewHolder extends RecyclerView.c0 {
    ...
    public static final void m166setApp$lambda0(EarnAppCoinsItemViewHolder earnAppCoinsItemViewHolder, RewardApp rewardApp, HomeBundle homeBundle, int i2, View view) {
        m.f(earnAppCoinsItemViewHolder, "this$0");
        m.f(rewardApp, "$app");
    ...
    public final void setApp(final RewardApp app, final HomeBundle homeBundle, final int bundlePosition) {
        ...
        this.itemView.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.appcoins.a
            ...
            public final void onClick(View view) {
                EarnAppCoinsItemViewHolder.m166setApp$lambda0(EarnAppCoinsItemViewHolder.this, app, homeBundle, bundlePosition, view);
            }
        });
    }
}
