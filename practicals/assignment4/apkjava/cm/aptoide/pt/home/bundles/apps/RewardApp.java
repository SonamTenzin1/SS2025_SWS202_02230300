...
public final class RewardApp extends Application {
    ...
    public static final /* data */ class Fiat {
        ...
        public boolean equals(Object other) {
            ...
            return m.a(Double.valueOf(this.amount), Double.valueOf(fiat.amount)) && m.a(this.currency, fiat.currency) && m.a(this.symbol, fiat.symbol);
        }
    ...
    public static final /* data */ class Reward {
        ...
        public boolean equals(Object other) {
            ...
            return m.a(Double.valueOf(this.appc), Double.valueOf(reward.appc)) && m.a(this.fiat, reward.fiat);
        }
    ...
    public RewardApp(String str, String str2, float f2, int i2, String str3, long j2, String str4, boolean z, String str5, String str6, Reward reward, String str7) {
        ...
        m.f(str4, StoreTabGridRecyclerFragment.BundleCons.TAG);
        this.clickUrl = str5;
