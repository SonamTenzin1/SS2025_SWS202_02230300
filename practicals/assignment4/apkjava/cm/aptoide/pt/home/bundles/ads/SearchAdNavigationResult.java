...
public final /* data */ class SearchAdNavigationResult {
    ...
    public SearchAdNavigationResult(String str, SearchAdResult searchAdResult) {
        m.f(str, StoreTabGridRecyclerFragment.BundleCons.TAG);
        m.f(searchAdResult, "searchAdResult");
        this.tag = str;
    ...
    public final SearchAdNavigationResult copy(String tag, SearchAdResult searchAdResult) {
        m.f(tag, StoreTabGridRecyclerFragment.BundleCons.TAG);
        m.f(searchAdResult, "searchAdResult");
    ...
    public boolean equals(Object other) {
        ...
        return m.a(this.tag, searchAdNavigationResult.tag) && m.a(this.searchAdResult, searchAdNavigationResult.searchAdResult);
    }
