...
public final class EarnAppcListManager {
    ...
    public EarnAppcListManager(WalletAppProvider walletAppProvider, WalletInstallManager walletInstallManager) {
        kotlin.jvm.internal.m.f(walletAppProvider, "walletAppProvider");
    ...
    public static final rx.b m182cancelWalletDownload$lambda4(EarnAppcListManager earnAppcListManager, WalletApp walletApp) {
        kotlin.jvm.internal.m.f(earnAppcListManager, "this$0");
        WalletInstallManager walletInstallManager = earnAppcListManager.walletInstallManager;
        kotlin.jvm.internal.m.e(walletApp, "app");
        return walletInstallManager.cancelDownload(walletApp);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: downloadApp$lambda-1, reason: not valid java name */
    public static final rx.b m183downloadApp$lambda1(EarnAppcListManager earnAppcListManager, WalletApp walletApp) {
        kotlin.jvm.internal.m.f(earnAppcListManager, "this$0");
        WalletInstallManager walletInstallManager = earnAppcListManager.walletInstallManager;
        kotlin.jvm.internal.m.e(walletApp, "app");
    ...
    public static final void m184getWalletApp$lambda0(EarnAppcListManager earnAppcListManager, WalletApp walletApp) {
        kotlin.jvm.internal.m.f(earnAppcListManager, "this$0");
    ...
    public static final rx.e m185loadWalletDownloadModel$lambda2(EarnAppcListManager earnAppcListManager, WalletApp walletApp) {
        kotlin.jvm.internal.m.f(earnAppcListManager, "this$0");
        WalletInstallManager walletInstallManager = earnAppcListManager.walletInstallManager;
        kotlin.jvm.internal.m.e(walletApp, "app");
    ...
    public static final rx.b m186pauseWalletDownload$lambda3(EarnAppcListManager earnAppcListManager, WalletApp walletApp) {
        kotlin.jvm.internal.m.f(earnAppcListManager, "this$0");
        WalletInstallManager walletInstallManager = earnAppcListManager.walletInstallManager;
        kotlin.jvm.internal.m.e(walletApp, "app");
    ...
    public static final rx.b m187resumeWalletDownload$lambda5(EarnAppcListManager earnAppcListManager, WalletApp walletApp) {
        kotlin.jvm.internal.m.f(earnAppcListManager, "this$0");
        WalletInstallManager walletInstallManager = earnAppcListManager.walletInstallManager;
        kotlin.jvm.internal.m.e(walletApp, "app");
    ...
    public final rx.b cancelWalletDownload() {
        rx.b X0 = getWalletApp().H(new rx.m.e() { // from class: cm.aptoide.pt.home.more.appcoins.e
            ...
            public final Object call(Object obj) {
                rx.b m182cancelWalletDownload$lambda4;
                m182cancelWalletDownload$lambda4 = EarnAppcListManager.m182cancelWalletDownload$lambda4(EarnAppcListManager.this, (WalletApp) obj);
                return m182cancelWalletDownload$lambda4;
            }
        }).X0();
        kotlin.jvm.internal.m.e(X0, "getWalletApp()\n        .…\n        .toCompletable()");
        return X0;
    }
    ...
    public final rx.b downloadApp() {
        rx.b X0 = getWalletApp().H(new rx.m.e() { // from class: cm.aptoide.pt.home.more.appcoins.h
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m183downloadApp$lambda1;
                m183downloadApp$lambda1 = EarnAppcListManager.m183downloadApp$lambda1(EarnAppcListManager.this, (WalletApp) obj);
                return m183downloadApp$lambda1;
            }
        }).X0();
        kotlin.jvm.internal.m.e(X0, "getWalletApp()\n        .…\n        .toCompletable()");
        return X0;
    ...
    public final rx.e<WalletApp> getWalletApp() {
        ...
        if (walletApp != null) {
            ...
            kotlin.jvm.internal.m.e(S, "just(cachedWalletApp)");
            return S;
        }
        rx.e<WalletApp> x = this.walletAppProvider.getWalletApp().x(new rx.m.b() { // from class: cm.aptoide.pt.home.more.appcoins.g
            @Override // rx.m.b
            public final void call(Object obj) {
                EarnAppcListManager.m184getWalletApp$lambda0(EarnAppcListManager.this, (WalletApp) obj);
            }
        });
        kotlin.jvm.internal.m.e(x, "walletAppProvider.getWal…edWalletApp = walletApp }");
        return x;
    }
    ...
    public final rx.e<DownloadModel> loadWalletDownloadModel() {
        rx.e G = getWalletApp().G(new rx.m.e() { // from class: cm.aptoide.pt.home.more.appcoins.f
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.e m185loadWalletDownloadModel$lambda2;
                m185loadWalletDownloadModel$lambda2 = EarnAppcListManager.m185loadWalletDownloadModel$lambda2(EarnAppcListManager.this, (WalletApp) obj);
                return m185loadWalletDownloadModel$lambda2;
            }
        });
        kotlin.jvm.internal.m.e(G, "getWalletApp()\n        .….loadDownloadModel(app) }");
        return G;
    }
    ...
    public final rx.b pauseWalletDownload() {
        rx.b X0 = getWalletApp().H(new rx.m.e() { // from class: cm.aptoide.pt.home.more.appcoins.d
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m186pauseWalletDownload$lambda3;
                m186pauseWalletDownload$lambda3 = EarnAppcListManager.m186pauseWalletDownload$lambda3(EarnAppcListManager.this, (WalletApp) obj);
                return m186pauseWalletDownload$lambda3;
            }
        }).X0();
        kotlin.jvm.internal.m.e(X0, "getWalletApp()\n        .…\n        .toCompletable()");
        return X0;
    ...
    public final rx.b resumeWalletDownload() {
        rx.b X0 = getWalletApp().H(new rx.m.e() { // from class: cm.aptoide.pt.home.more.appcoins.i
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m187resumeWalletDownload$lambda5;
                m187resumeWalletDownload$lambda5 = EarnAppcListManager.m187resumeWalletDownload$lambda5(EarnAppcListManager.this, (WalletApp) obj);
                return m187resumeWalletDownload$lambda5;
            }
        }).X0();
        kotlin.jvm.internal.m.e(X0, "getWalletApp()\n        .…\n        .toCompletable()");
        return X0;
