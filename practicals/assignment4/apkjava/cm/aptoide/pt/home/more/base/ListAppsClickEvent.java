...
public final /* data */ class ListAppsClickEvent<T extends Application> {
    ...
    public ListAppsClickEvent(T t, int i2) {
        kotlin.jvm.internal.m.f(t, "application");
        this.application = t;
        this.appPosition = i2;
    }
    ...
    public boolean equals(Object other) {
        ...
        return kotlin.jvm.internal.m.a(this.application, listAppsClickEvent.application) && this.appPosition == listAppsClickEvent.appPosition;
    }
