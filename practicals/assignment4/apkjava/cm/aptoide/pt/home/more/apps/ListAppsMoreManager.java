...
public final class ListAppsMoreManager {
    ...
    public final e<List<Application>> loadFreshApps(String str, boolean z, String str2, Integer num) {
        ...
        r = u.r(str2, "getAds", false, 2, null);
        if (r) {
            e X = this.adsRepository.getAdsFromHomepageMore(z).X(new rx.m.e() { // from class: cm.aptoide.pt.home.more.apps.c
                @Override // rx.m.e
                public final Object call(Object obj) {
                    List m236loadFreshApps$lambda0;
                    m236loadFreshApps$lambda0 = ListAppsMoreManager.m236loadFreshApps$lambda0(ListAppsMoreManager.this, (List) obj);
                    return m236loadFreshApps$lambda0;
                }
            });
            m.e(X, "adsRepository.getAdsFrom…apAdsResponse(response) }");
            return X;
        }
        e X2 = this.listAppsMoreRepository.getApps(str, z).X(new rx.m.e() { // from class: cm.aptoide.pt.home.more.apps.b
            @Override // rx.m.e
            public final Object call(Object obj) {
                List m237loadFreshApps$lambda1;
                m237loadFreshApps$lambda1 = ListAppsMoreManager.m237loadFreshApps$lambda1(ListAppsMoreManager.this, (ListApps) obj);
                return m237loadFreshApps$lambda1;
            }
        });
        m.e(X2, "listAppsMoreRepository.g…> mapResponse(response) }");
        return X2;
    }
    ...
    public final e<List<Application>> loadMoreApps(String str, boolean z, String str2) {
        ...
        int i2;
        r = u.r(str2, "getAds", false, 2, null);
        if (!r && (i2 = this.next) < this.total) {
            e X = this.listAppsMoreRepository.loadMoreApps(str, z, i2).X(new rx.m.e() { // from class: cm.aptoide.pt.home.more.apps.a
                @Override // rx.m.e
                public final Object call(Object obj) {
                    List m238loadMoreApps$lambda2;
                    m238loadMoreApps$lambda2 = ListAppsMoreManager.m238loadMoreApps$lambda2(ListAppsMoreManager.this, (ListApps) obj);
                    return m238loadMoreApps$lambda2;
                }
            });
