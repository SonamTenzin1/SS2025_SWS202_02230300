...
public abstract class UpdateCardModel extends t<CardHolder> {
    ...
    public static final class CardHolder extends BaseViewHolder {
        static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {g0.h(new y(CardHolder.class, "name", "getName()Landroid/widget/TextView;", 0)), g0.h(new y(CardHolder.class, "appIcon", "getAppIcon()Landroid/widget/ImageView;", 0)), g0.h(new y(CardHolder.class, "secondaryText", "getSecondaryText()Landroid/widget/TextView;", 0)), g0.h(new y(CardHolder.class, "secondaryIcon", "getSecondaryIcon()Landroid/widget/ImageView;", 0)), g0.h(new y(CardHolder.class, "tertiaryText", "getTertiaryText()Landroid/widget/TextView;", 0)), g0.h(new y(CardHolder.class, "actionButton", "getActionButton()Landroid/widget/ImageView;", 0)), g0.h(new y(CardHolder.class, "downloadProgressView", "getDownloadProgressView()Lcm/aptoide/aptoideviews/downloadprogressview/DownloadProgressView;", 0)), g0.h(new y(CardHolder.class, "rootLayout", "getRootLayout()Landroidx/constraintlayout/widget/ConstraintLayout;", 0))};
    ...
    private final void setupListeners(final CardHolder holder, final UpdateApp app) {
        holder.getActionButton().setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.apps.list.models.d
            ...
            public final void onClick(View view) {
                UpdateCardModel.m163setupListeners$lambda1(UpdateCardModel.this, app, view);
            }
        });
        holder.getItemView().setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.apps.list.models.e
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UpdateCardModel.m164setupListeners$lambda2(UpdateCardModel.this, app, view);
            }
        });
        holder.getItemView().setOnLongClickListener(new View.OnLongClickListener() { // from class: cm.aptoide.pt.home.apps.list.models.c
            ...
            public final boolean onLongClick(View view) {
                boolean m165setupListeners$lambda3;
                m165setupListeners$lambda3 = UpdateCardModel.m165setupListeners$lambda3(UpdateCardModel.this, app, view);
                return m165setupListeners$lambda3;
            }
        });
    ...
    public static final void m163setupListeners$lambda1(UpdateCardModel updateCardModel, UpdateApp updateApp, View view) {
        m.f(updateCardModel, "this$0");
        m.f(updateApp, "$app");
    ...
    public static final void m164setupListeners$lambda2(UpdateCardModel updateCardModel, UpdateApp updateApp, View view) {
        m.f(updateCardModel, "this$0");
        m.f(updateApp, "$app");
        rx.s.b<AppClick> bVar = updateCardModel.eventSubject;
        if (bVar != null) {
    ...
    public static final boolean m165setupListeners$lambda3(UpdateCardModel updateCardModel, UpdateApp updateApp, View view) {
        m.f(updateCardModel, "this$0");
        m.f(updateApp, "$app");
        rx.s.b<AppClick> bVar = updateCardModel.eventSubject;
        if (bVar == null) {
    ...
    public void bind2(CardHolder cardHolder, s<?> sVar) {
        m.f(cardHolder, "holder");
        m.f(sVar, "previouslyBoundModel");
        UpdateApp updateApp = this.application;
        if (updateApp != null) {
