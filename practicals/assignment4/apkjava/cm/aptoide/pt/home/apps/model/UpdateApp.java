...
public final /* data */ class UpdateApp implements StateApp {
    ...
    public boolean equals(Object other) {
        ...
        return m.a(this.name, updateApp.name) && m.a(getMd5(), updateApp.getMd5()) && m.a(this.icon, updateApp.icon) && m.a(getPackageName(), updateApp.getPackageName()) && getProgress() == updateApp.getProgress() && m.a(this.version, updateApp.version) && getVersionCode() == updateApp.getVersionCode() && getStatus() == updateApp.getStatus() && this.appId == updateApp.appId && this.isInstalledWithAptoide == updateApp.isInstalledWithAptoide;
    }
