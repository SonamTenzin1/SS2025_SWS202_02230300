...
public final /* data */ class InstallCandidate {
    ...
    public InstallCandidate(String str, boolean z, boolean z2) {
        kotlin.jvm.internal.m.f(str, "md5");
        this.md5 = str;
    ...
    public boolean equals(Object other) {
        ...
        return kotlin.jvm.internal.m.a(this.md5, installCandidate.md5) && this.forceDefaultInstall == installCandidate.forceDefaultInstall && this.shouldSetPackageInstaller == installCandidate.shouldSetPackageInstaller;
    }
