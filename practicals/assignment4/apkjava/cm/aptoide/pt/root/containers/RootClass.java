        ...
        */
        protected File getBuiltPath() {
            ...
            if (file2.isDirectory()) {
                File[] listFiles = file2.listFiles(new FileFilter() { // from class: cm.aptoide.pt.root.containers.RootClass.AnnotationsFinder.2
                ...
                if (listFiles.length > 0) {
                    file = new File(file2.getAbsolutePath() + str + listFiles[0].getName());
                    if (file == null) {
                        return file;
                    }
                    File file3 = new File("bin" + str + "classes");
                    return file3.isDirectory() ? file3 : file;
                }
            }
            file = null;
            if (file == null) {
