...
public class LoginSignUpCredentialsFragment extends GooglePlayServicesFragment implements LoginSignUpCredentialsView, MagicLinkView, NotBottomNavigationView {
    ...
    public rx.e<String> getMagicLinkClick() {
        return this.sendMagicLinkView.getMagicLinkSubmit().X(new rx.m.e() { // from class: cm.aptoide.pt.account.view.b1
            @Override // rx.m.e
    ...
    public rx.e<Boolean> showAptoideLoginAreaClick() {
        return e.g.a.c.a.a(this.connectWithEmailButton).X(new rx.m.e() { // from class: cm.aptoide.pt.account.view.y0
            @Override // rx.m.e
            public final Object call(Object obj) {
    ...
    public void showTermsConditionError() {
        ...
        this.termsConditionsCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: cm.aptoide.pt.account.view.w0
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                LoginSignUpCredentialsFragment.this.h(compoundButton, z);
            }
        });
    }
