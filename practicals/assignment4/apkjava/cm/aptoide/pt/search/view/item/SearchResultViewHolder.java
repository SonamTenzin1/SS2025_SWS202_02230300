...
public final class SearchResultViewHolder extends SearchResultItemView<SearchAppResult> {
    ...
    public SearchResultViewHolder(View view, rx.s.b<SearchAppResultWrapper> bVar, rx.s.b<DownloadClick> bVar2, rx.s.b<ScreenShotClickEvent> bVar3, String str) {
        super(view);
        m.f(view, "itemView");
        m.f(bVar, "itemClickSubject");
        m.f(bVar2, "downloadClickSubject");
        m.f(bVar3, "screenShotClick");
    ...
    private final void setAppInfo(final SearchAppResult result) {
        ...
        if (developerName == null || developerName.length() == 0) {
            ((TextView) this.itemView.findViewById(R.id.developer_name)).setVisibility(4);
        } else {
            ((TextView) this.itemView.findViewById(R.id.developer_name)).setText(result.getDeveloperName());
        }
        ...
        this.itemView.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.search.view.item.a
            ...
            public final void onClick(View view7) {
                SearchResultViewHolder.m311setAppInfo$lambda2(SearchResultViewHolder.this, result, view7);
            }
        });
    }
    ...
    public static final void m311setAppInfo$lambda2(SearchResultViewHolder searchResultViewHolder, SearchAppResult searchAppResult, View view) {
        m.f(searchResultViewHolder, "this$0");
        m.f(searchAppResult, "$result");
    ...
    public final void setDownloadStatus(SearchAppResult app) {
        ...
        if (app.isHighlightedResult() && downloadModel != null) {
            ...
            m.e(screenshots, "app.screenshots");
