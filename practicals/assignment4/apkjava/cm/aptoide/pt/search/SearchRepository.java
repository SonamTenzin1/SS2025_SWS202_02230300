...
public final class SearchRepository {
    ...
    private final boolean isQuerySameAsAppName(String appName, String query) {
        ...
        A = kotlin.text.u.A(lowerCase, " ", HttpUrl.FRAGMENT_ENCODE_SET, false, 4, null);
        A2 = kotlin.text.u.A(A, "-", HttpUrl.FRAGMENT_ENCODE_SET, false, 4, null);
        String lowerCase2 = query.toLowerCase();
        kotlin.jvm.internal.m.e(lowerCase2, "this as java.lang.String).toLowerCase()");
        A3 = kotlin.text.u.A(lowerCase2, " ", HttpUrl.FRAGMENT_ENCODE_SET, false, 4, null);
        A4 = kotlin.text.u.A(A3, "-", HttpUrl.FRAGMENT_ENCODE_SET, false, 4, null);
        return kotlin.jvm.internal.m.a(A2, A4);
    }
    ...
    private final rx.e<List<SearchAppResult>> mapToSearchAppResultList(List<? extends SearchApp> list, String str) {
        ...
        kotlin.jvm.internal.m.e(S, "just(newList)");
        return S;
    }
        ...
        if (response != null) {
            Single<SearchResult> q = rx.e.S(response.getDataList().getList()).G(new rx.m.e() { // from class: cm.aptoide.pt.search.s
                ...
                public final Object call(Object obj) {
                    rx.e m294mapToSearchResult$lambda20$lambda17;
                    m294mapToSearchResult$lambda20$lambda17 = SearchRepository.m294mapToSearchResult$lambda20$lambda17(SearchRepository.this, query, (List) obj);
                    return m294mapToSearchResult$lambda20$lambda17;
                }
            }).E().X(new rx.m.e() { // from class: cm.aptoide.pt.search.n
                @Override // rx.m.e
                public final Object call(Object obj) {
                    SearchResult m295mapToSearchResult$lambda20$lambda18;
                    m295mapToSearchResult$lambda20$lambda18 = SearchRepository.m295mapToSearchResult$lambda20$lambda18(query, specificStore, filters, response, (List) obj);
                    return m295mapToSearchResult$lambda20$lambda18;
                }
            }).Z0().q(new rx.m.e() { // from class: cm.aptoide.pt.search.i
                @Override // rx.m.e
                public final Object call(Object obj) {
                    Single m296mapToSearchResult$lambda20$lambda19;
                    m296mapToSearchResult$lambda20$lambda19 = SearchRepository.m296mapToSearchResult$lambda20$lambda19(SearchRepository.this, query, specificStore, (Throwable) obj);
                    return m296mapToSearchResult$lambda20$lambda19;
                }
            });
            kotlin.jvm.internal.m.e(q, "just(r.dataList.list)\n  …ore, throwable)\n        }");
            return q;
        }
        Single<SearchResult> m = Single.m(new SearchResult(query, SearchResultError.GENERIC));
        kotlin.jvm.internal.m.e(m, "just(SearchResult(query,…archResultError.GENERIC))");
        return m;
    }
    ...
    private final Single<SearchResult> requestSearchResults(final String query, final SearchFilters filters, int nextOffset, boolean matureEnabled, final String specificStore) {
        ...
        Single<SearchResult> q = of.observe(false).Z0().i(new rx.m.e() { // from class: cm.aptoide.pt.search.g
            @Override // rx.m.e
            public final Object call(Object obj) {
                Single m297requestSearchResults$lambda15;
                m297requestSearchResults$lambda15 = SearchRepository.m297requestSearchResults$lambda15(SearchRepository.this, query, filters, specificStore, (ListSearchApps) obj);
                return m297requestSearchResults$lambda15;
            }
        }).q(new rx.m.e() { // from class: cm.aptoide.pt.search.p
            @Override // rx.m.e
            public final Object call(Object obj) {
                Single m298requestSearchResults$lambda16;
                m298requestSearchResults$lambda16 = SearchRepository.m298requestSearchResults$lambda16(SearchRepository.this, query, specificStore, (Throwable) obj);
                return m298requestSearchResults$lambda16;
            }
        });
        kotlin.jvm.internal.m.e(q, "request\n      .observe(f…Store, throwable)\n      }");
        return q;
    }
    ...
    private final synchronized rx.b search(String str, SearchFilters searchFilters, boolean z, String str2, boolean z2) {
        if (z2) {
            rx.b t = rx.b.t(new rx.m.a() { // from class: cm.aptoide.pt.search.u
                ...
                public final void call() {
                    SearchRepository.m300search$lambda2(SearchRepository.this);
                }
            });
            kotlin.jvm.internal.m.e(t, "fromAction {\n        res…hedSearchResults)\n      }");
            return t;
        }
        ...
        if (searchResult != null && kotlin.jvm.internal.m.a(searchResult.getQuery(), str) && kotlin.jvm.internal.m.a(searchResult.getSpecificStore(), str2) && kotlin.jvm.internal.m.a(searchFilters, searchResult.getFilters()) && !searchResult.hasError()) {
            if (searchResult.hasMore()) {
                if (this.loadingMore) {
                    rx.b e2 = rx.b.e();
                    kotlin.jvm.internal.m.e(e2, "complete()");
                    return e2;
                }
                rx.b n = requestSearchResults(str, searchFilters, searchResult.getNextOffset(), z, str2).A().P0(this.cancelationSubject).o(null).Z0().j(new rx.m.e() { // from class: cm.aptoide.pt.search.h
                    @Override // rx.m.e
                    public final Object call(Object obj) {
                        rx.b m301search$lambda9$lambda3;
                        m301search$lambda9$lambda3 = SearchRepository.m301search$lambda9$lambda3(SearchRepository.this, (SearchResult) obj);
                        return m301search$lambda9$lambda3;
                    }
                }).p(new rx.m.b() { // from class: cm.aptoide.pt.search.o
                    @Override // rx.m.b
                    public final void call(Object obj) {
                        SearchRepository.m302search$lambda9$lambda4(SearchRepository.this, (rx.k) obj);
                    }
                }).r(new rx.m.a() { // from class: cm.aptoide.pt.search.k
                    @Override // rx.m.a
                    public final void call() {
                        SearchRepository.m303search$lambda9$lambda5(SearchRepository.this);
                    }
                }).q(new rx.m.a() { // from class: cm.aptoide.pt.search.r
                    @Override // rx.m.a
                    public final void call() {
                        SearchRepository.m304search$lambda9$lambda6(SearchRepository.this);
                    }
                }).n(new rx.m.b() { // from class: cm.aptoide.pt.search.t
                    @Override // rx.m.b
                    public final void call(Object obj) {
                        SearchRepository.m305search$lambda9$lambda7(SearchRepository.this, (Throwable) obj);
                    }
                });
                kotlin.jvm.internal.m.e(n, "requestSearchResults(\n  …r { loadingMore = false }");
                return n;
            }
            rx.b t2 = rx.b.t(new rx.m.a() { // from class: cm.aptoide.pt.search.q
                @Override // rx.m.a
                public final void call() {
                    SearchRepository.m306search$lambda9$lambda8(SearchRepository.this, searchResult);
                }
            });
            kotlin.jvm.internal.m.e(t2, "fromAction {\n           …ctiveResults)\n          }");
            return t2;
        }
        ...
        rx.b j2 = requestSearchResults(str, searchFilters, 0, z, str2).A().P0(this.cancelationSubject).o(null).Z0().j(new rx.m.e() { // from class: cm.aptoide.pt.search.j
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m299search$lambda10;
                m299search$lambda10 = SearchRepository.m299search$lambda10(SearchRepository.this, (SearchResult) obj);
                return m299search$lambda10;
            }
        });
        kotlin.jvm.internal.m.e(j2, "requestSearchResults(que…updateMemCache(results) }");
        return j2;
    }
    ...
    private final synchronized rx.b updateMemCache(final SearchResult searchResult) {
        ...
        t = rx.b.t(new rx.m.a() { // from class: cm.aptoide.pt.search.m
            @Override // rx.m.a
            public final void call() {
                SearchRepository.m308updateMemCache$lambda13(SearchResult.this, this);
            }
        });
        kotlin.jvm.internal.m.e(t, "fromAction {\n      resul…)\n        }\n      }\n    }");
        return t;
    ...
    public final rx.b generalSearch(final String str, final SearchFilters searchFilters, final boolean z, final boolean z2) {
        ...
        rx.b K = Single.m(str).j(new rx.m.e() { // from class: cm.aptoide.pt.search.l
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m293generalSearch$lambda0;
                m293generalSearch$lambda0 = SearchRepository.m293generalSearch$lambda0(SearchRepository.this, str, searchFilters, z, z2, (String) obj);
                return m293generalSearch$lambda0;
            }
        }).K(Schedulers.io());
        kotlin.jvm.internal.m.e(K, "just(query)\n      .flatM…scribeOn(Schedulers.io())");
        return K;
    }
    ...
    public final rx.b searchInStore(final String str, final SearchFilters searchFilters, final boolean z, final String str2, final boolean z2) {
        ...
        rx.b K = Single.m(str).j(new rx.m.e() { // from class: cm.aptoide.pt.search.v
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m307searchInStore$lambda1;
                m307searchInStore$lambda1 = SearchRepository.m307searchInStore$lambda1(SearchRepository.this, str, searchFilters, z, str2, z2, (String) obj);
                return m307searchInStore$lambda1;
            }
        }).K(Schedulers.io());
        kotlin.jvm.internal.m.e(K, "just(query)\n      .flatM…scribeOn(Schedulers.io())");
        return K;
