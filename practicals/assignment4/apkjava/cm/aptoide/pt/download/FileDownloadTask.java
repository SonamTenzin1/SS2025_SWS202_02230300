    ...
    public void error(e.h.a.a aVar, Throwable th) {
        ...
        if (th != null) {
            ...
            if (th instanceof FileDownloadHttpException) {
                int b2 = ((FileDownloadHttpException) th).b();
                if (b2 == FILE_NOT_FOUND_HTTP_ERROR) {
                    Logger.getInstance().d("FileDownloader", "File not found error on app: " + this.md5);
                    fileDownloadTaskStatus = new FileDownloadTaskStatus(AppDownloadStatus.AppDownloadState.ERROR_FILE_NOT_FOUND, this.md5, new DownloadError(th, String.valueOf(b2), aVar.n()), aVar.c(), this.fileType);
                } else {
                    Logger.getInstance().d("FileDownloader", "Http error + " + b2 + " on app: " + this.md5);
                    fileDownloadTaskStatus = new FileDownloadTaskStatus(AppDownloadStatus.AppDownloadState.ERROR, this.md5, new DownloadError(th, String.valueOf(b2), aVar.n()), aVar.c(), this.fileType);
                }
