...
public final class OutOfSpaceManager {
    ...
    public static final rx.e m138getInstalledApps$lambda2(List list) {
        return rx.e.N(list).D(new rx.m.e() { // from class: cm.aptoide.pt.download.view.outofspace.f0
            ...
            public final Object call(Object obj) {
                Boolean m139getInstalledApps$lambda2$lambda0;
                m139getInstalledApps$lambda2$lambda0 = OutOfSpaceManager.m139getInstalledApps$lambda2$lambda0((RoomInstalled) obj);
                return m139getInstalledApps$lambda2$lambda0;
            }
        }).X(new rx.m.e() { // from class: cm.aptoide.pt.download.view.outofspace.b0
            @Override // rx.m.e
            public final Object call(Object obj) {
                InstalledApp m140getInstalledApps$lambda2$lambda1;
                m140getInstalledApps$lambda2$lambda1 = OutOfSpaceManager.m140getInstalledApps$lambda2$lambda1((RoomInstalled) obj);
                return m140getInstalledApps$lambda2$lambda1;
            }
        }).Y0();
    }
    ...
    public static final Single m142uninstallApp$lambda4(final OutOfSpaceManager outOfSpaceManager, String str, final Long l) {
        ...
        return outOfSpaceManager.installManager.uninstallApp(str).c(Single.m(l)).g(new rx.m.b() { // from class: cm.aptoide.pt.download.view.outofspace.e0
            ...
            public final void call(Object obj) {
                OutOfSpaceManager.m143uninstallApp$lambda4$lambda3(OutOfSpaceManager.this, l, (Long) obj);
            }
        });
    }
    ...
    public final rx.e<List<InstalledApp>> getInstalledApps() {
        rx.e G = this.installManager.fetchInstalledExceptSystem().G(new rx.m.e() { // from class: cm.aptoide.pt.download.view.outofspace.g0
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.e m138getInstalledApps$lambda2;
                m138getInstalledApps$lambda2 = OutOfSpaceManager.m138getInstalledApps$lambda2((List) obj);
                return m138getInstalledApps$lambda2;
            }
        });
        kotlin.jvm.internal.m.e(G, "installManager.fetchInst…      .toList()\n        }");
        return G;
    }
    ...
    public final Single<Long> getRequiredStorageSize() {
        Single<Long> g2 = Single.m(Long.valueOf(this.appSize - this.installAppSizeValidator.getAvailableSpace())).g(new rx.m.b() { // from class: cm.aptoide.pt.download.view.outofspace.c0
            @Override // rx.m.b
            public final void call(Object obj) {
                OutOfSpaceManager.m141getRequiredStorageSize$lambda6(OutOfSpaceManager.this, (Long) obj);
            }
        });
        kotlin.jvm.internal.m.e(g2, "just(appSize - installAp…ss { requiredSpace = it }");
        return g2;
    }
    ...
    public final Single<Long> uninstallApp(final String packageName) {
        Single<Long> n = getInstalledAppSize(packageName).i(new rx.m.e() { // from class: cm.aptoide.pt.download.view.outofspace.h0
            @Override // rx.m.e
            public final Object call(Object obj) {
                Single m142uninstallApp$lambda4;
                m142uninstallApp$lambda4 = OutOfSpaceManager.m142uninstallApp$lambda4(OutOfSpaceManager.this, packageName, (Long) obj);
                return m142uninstallApp$lambda4;
            }
        }).n(new rx.m.e() { // from class: cm.aptoide.pt.download.view.outofspace.d0
            @Override // rx.m.e
            public final Object call(Object obj) {
                Long m144uninstallApp$lambda5;
                m144uninstallApp$lambda5 = OutOfSpaceManager.m144uninstallApp$lambda5(OutOfSpaceManager.this, (Long) obj);
                return m144uninstallApp$lambda5;
            }
        });
        kotlin.jvm.internal.m.e(n, "getInstalledAppSize(pack…  }.map { requiredSpace }");
        return n;
    }
