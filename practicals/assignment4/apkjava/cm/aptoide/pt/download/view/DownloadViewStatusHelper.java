...
public final class DownloadViewStatusHelper {
    ...
    public static final void m110setupListeners$lambda0(rx.s.b bVar, Download download, View view) {
        kotlin.jvm.internal.m.f(bVar, "$downloadClickSubject");
    ...
    public final void setDownloadStatus(Download download, Button button, DownloadProgressView downloadProgressView, rx.s.b<DownloadClick> bVar) {
        ...
        kotlin.jvm.internal.m.f(button, "installButton");
        kotlin.jvm.internal.m.f(downloadProgressView, "downloadProgressView");
        kotlin.jvm.internal.m.f(bVar, "downloadClickSubject");
    ...
    public final void setupListeners(final Download download, final rx.s.b<DownloadClick> bVar, Button button, DownloadProgressView downloadProgressView) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.download.view.j0
            ...
            public final void onClick(View view) {
                DownloadViewStatusHelper.m110setupListeners$lambda0(rx.s.b.this, download, view);
            }
        });
