...
public class DownloadViewActionPresenter extends ActionPresenter<DownloadClick> {
    ...
    private final rx.b cancelDownload(final DownloadClick downloadClick) {
        rx.b a = rx.b.t(new rx.m.a() { // from class: cm.aptoide.pt.download.view.t
            ...
            public final void call() {
                DownloadViewActionPresenter.m81cancelDownload$lambda28(DownloadViewActionPresenter.this, downloadClick);
            }
        ...
        kotlin.jvm.internal.m.e(a, "fromAction {\n      downl…versionCode\n      )\n    )");
        return a;
    }
    ...
    private final rx.e<RoomDownload> createDownload(final Download download, final List<DynamicSplit> list) {
        rx.e<RoomDownload> w = rx.e.S(list).G(new rx.m.e() { // from class: cm.aptoide.pt.download.view.e0
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.e m82createDownload$lambda22;
                m82createDownload$lambda22 = DownloadViewActionPresenter.m82createDownload$lambda22(DownloadViewActionPresenter.this, download, list, (List) obj);
                return m82createDownload$lambda22;
            }
        }).w(new rx.m.b() { // from class: cm.aptoide.pt.download.view.v
            @Override // rx.m.b
            public final void call(Object obj) {
                DownloadViewActionPresenter.m83createDownload$lambda23(DownloadViewActionPresenter.this, download, list, (Throwable) obj);
            }
        });
        kotlin.jvm.internal.m.e(w, "just(dynamicSplitsList)\n…      )\n        }\n      }");
        return w;
    }
    ...
    private final rx.b downgradeApp(final Download download) {
        rx.b X0 = this.downloadDialogProvider.showDowngradeDialog().D(new rx.m.e() { // from class: cm.aptoide.pt.download.view.q
            @Override // rx.m.e
            public final Object call(Object obj) {
        ...
        kotlin.jvm.internal.m.e(X0, "downloadDialogProvider.s… }\n      .toCompletable()");
        return X0;
    }
    ...
    private final rx.b downloadApp(final Download download) {
        rx.b X0 = rx.e.p(new rx.m.d() { // from class: cm.aptoide.pt.download.view.b0
            ...
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.e m90downloadApp$lambda21;
                m90downloadApp$lambda21 = DownloadViewActionPresenter.m90downloadApp$lambda21(DownloadViewActionPresenter.this, download, (Download) obj);
                return m90downloadApp$lambda21;
            }
        }).X0();
    ...
    public static final rx.e m87downloadApp$lambda14(final DownloadViewActionPresenter downloadViewActionPresenter, final Download download) {
        ...
        if (downloadViewActionPresenter.installManager.showWarning()) {
            return downloadViewActionPresenter.downloadDialogProvider.showRootInstallWarningPopup().x(new rx.m.b() { // from class: cm.aptoide.pt.download.view.p
                @Override // rx.m.b
                public final void call(Object obj) {
    ...
    public static final rx.e m90downloadApp$lambda21(final DownloadViewActionPresenter downloadViewActionPresenter, final Download download, Download download2) {
        ...
        return downloadViewActionPresenter.permissionManager.requestDownloadAccessWithWifiBypass(downloadViewActionPresenter.permissionService, download.getSize()).G(new rx.m.e() { // from class: cm.aptoide.pt.download.view.h0
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.e m91downloadApp$lambda21$lambda16;
                m91downloadApp$lambda21$lambda16 = DownloadViewActionPresenter.m91downloadApp$lambda21$lambda16(DownloadViewActionPresenter.this, download, (Void) obj);
                return m91downloadApp$lambda21$lambda16;
            }
        }).L(new rx.m.e() { // from class: cm.aptoide.pt.download.view.j
            @Override // rx.m.e
            public final Object call(Object obj) {
                Single m93downloadApp$lambda21$lambda17;
                m93downloadApp$lambda21$lambda17 = DownloadViewActionPresenter.m93downloadApp$lambda21$lambda17(DownloadViewActionPresenter.this, download, (Void) obj);
                return m93downloadApp$lambda21$lambda17;
            }
        }).j0(downloadViewActionPresenter.ioScheduler).H(new rx.m.e() { // from class: cm.aptoide.pt.download.view.s
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m94downloadApp$lambda21$lambda20;
                m94downloadApp$lambda21$lambda20 = DownloadViewActionPresenter.m94downloadApp$lambda21$lambda20(DownloadViewActionPresenter.this, download, (DynamicSplitsModel) obj);
                return m94downloadApp$lambda21$lambda20;
            }
        });
    }
    ...
    public static final rx.e m91downloadApp$lambda21$lambda16(final DownloadViewActionPresenter downloadViewActionPresenter, final Download download, Void r3) {
        ...
        return downloadViewActionPresenter.permissionManager.requestExternalStoragePermission(downloadViewActionPresenter.permissionService).w(new rx.m.b() { // from class: cm.aptoide.pt.download.view.m
            @Override // rx.m.b
            public final void call(Object obj) {
                DownloadViewActionPresenter.m92downloadApp$lambda21$lambda16$lambda15(DownloadViewActionPresenter.this, download, (Throwable) obj);
            }
        });
    }
    ...
    public static final rx.b m94downloadApp$lambda21$lambda20(final DownloadViewActionPresenter downloadViewActionPresenter, final Download download, DynamicSplitsModel dynamicSplitsModel) {
        ...
        return downloadViewActionPresenter.createDownload(download, dynamicSplitsModel.getDynamicSplitsList()).x(new rx.m.b() { // from class: cm.aptoide.pt.download.view.i
            @Override // rx.m.b
            public final void call(Object obj) {
                DownloadViewActionPresenter.m95downloadApp$lambda21$lambda20$lambda18(DownloadViewActionPresenter.this, download, (RoomDownload) obj);
            }
        }).H(new rx.m.e() { // from class: cm.aptoide.pt.download.view.u
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m96downloadApp$lambda21$lambda20$lambda19;
                m96downloadApp$lambda21$lambda20$lambda19 = DownloadViewActionPresenter.m96downloadApp$lambda21$lambda20$lambda19(DownloadViewActionPresenter.this, (RoomDownload) obj);
                return m96downloadApp$lambda21$lambda20$lambda19;
            }
        }).X0();
    }
    ...
    private final rx.b handleOutOfSpaceError(final DownloadClick downloadClick) {
        rx.b n = rx.b.t(new rx.m.a() { // from class: cm.aptoide.pt.download.view.k
            @Override // rx.m.a
            public final void call() {
                DownloadViewActionPresenter.m97handleOutOfSpaceError$lambda6(DownloadViewActionPresenter.this, downloadClick);
            }
            ...
            @Override // rx.m.e
            public final Object call(Object obj) {
                Boolean m98handleOutOfSpaceError$lambda7;
                m98handleOutOfSpaceError$lambda7 = DownloadViewActionPresenter.m98handleOutOfSpaceError$lambda7((OutOfSpaceNavigatorWrapper) obj);
                return m98handleOutOfSpaceError$lambda7;
            }
        ...
        kotlin.jvm.internal.m.e(n, "fromAction {\n      downl…printStackTrace()\n      }");
        return n;
    }
    ...
    private final rx.b installApp(DownloadClick downloadClick) {
        ...
        if (i2 == 1 || i2 == 2 || i2 == 3) {
            ...
            kotlin.jvm.internal.m.e(a, "downloadApp(downloadClic…            }\n          )");
            return a;
        }
        if (i2 != 4) {
            if (i2 != 5) {
                rx.b e4 = rx.b.e();
                kotlin.jvm.internal.m.e(e4, "complete()");
                return e4;
            }
        ...
        kotlin.jvm.internal.m.e(a2, "downgradeApp(downloadCli…            }\n          )");
        return a2;
    }
    ...
    private final rx.b pauseDownload(final DownloadClick downloadClick) {
        rx.b a = rx.b.t(new rx.m.a() { // from class: cm.aptoide.pt.download.view.l
            @Override // rx.m.a
            public final void call() {
                DownloadViewActionPresenter.m100pauseDownload$lambda27(DownloadViewActionPresenter.this, downloadClick);
            }
    ...
    public static final rx.e m102present$lambda3(final DownloadViewActionPresenter downloadViewActionPresenter, View.LifecycleEvent lifecycleEvent) {
        ...
        return downloadViewActionPresenter.getEventObservable().B0(new rx.m.e() { // from class: cm.aptoide.pt.download.view.y
            @Override // rx.m.e
            public final Object call(Object obj) {
                Boolean m103present$lambda3$lambda1;
                m103present$lambda3$lambda1 = DownloadViewActionPresenter.m103present$lambda3$lambda1((DownloadClick) obj);
                return m103present$lambda3$lambda1;
            }
        }).H(new rx.m.e() { // from class: cm.aptoide.pt.download.view.h
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m104present$lambda3$lambda2;
                m104present$lambda3$lambda2 = DownloadViewActionPresenter.m104present$lambda3$lambda2(DownloadViewActionPresenter.this, (DownloadClick) obj);
                return m104present$lambda3$lambda2;
            }
        }).s0();
    }
    ...
    private final rx.b resumeDownload(final DownloadClick downloadClick) {
        rx.b j2 = this.installManager.getDownload(downloadClick.getDownload().getMd5()).g(new rx.m.b() { // from class: cm.aptoide.pt.download.view.a0
            @Override // rx.m.b
            public final void call(Object obj) {
                DownloadViewActionPresenter.m107resumeDownload$lambda24(DownloadClick.this, this, (RoomDownload) obj);
            }
            ...
            @Override // rx.m.e
            public final Object call(Object obj) {
                rx.b m109resumeDownload$lambda26;
                m109resumeDownload$lambda26 = DownloadViewActionPresenter.m109resumeDownload$lambda26(DownloadViewActionPresenter.this, (RoomDownload) obj);
                return m109resumeDownload$lambda26;
            }
        });
        kotlin.jvm.internal.m.e(j2, "installManager.getDownlo…nager.install(download) }");
        return j2;
    }
    ...
    protected void present() {
        if (this.analyticsContext != null) {
            getLifecycleView().getLifecycleEvent().D(new rx.m.e() { // from class: cm.aptoide.pt.download.view.n
                @Override // rx.m.e
                public final Object call(Object obj) {
                    Boolean m101present$lambda0;
                    m101present$lambda0 = DownloadViewActionPresenter.m101present$lambda0((View.LifecycleEvent) obj);
                    return m101present$lambda0;
                }
            }).G(new rx.m.e() { // from class: cm.aptoide.pt.download.view.r
                @Override // rx.m.e
                public final Object call(Object obj) {
                    rx.e m102present$lambda3;
                    m102present$lambda3 = DownloadViewActionPresenter.m102present$lambda3(DownloadViewActionPresenter.this, (View.LifecycleEvent) obj);
                    return m102present$lambda3;
                }
                ...
                @Override // rx.m.b
                public final void call(Object obj) {
                    DownloadViewActionPresenter.m106present$lambda5(DownloadViewActionPresenter.this, (Throwable) obj);
                }
            });
            return;
        }
    ...
    public final void setupDownloadEvents(RoomDownload download, long appId, DownloadStatusModel.Action downloadAction, String storeName, String malwareRank, String appCategory) {
        ...
        r = kotlin.text.u.r(storeName, "catappult", false, 2, null);
        installAnalytics.installStarted(packageName, versionCode, action, appContext, origin, campaignId, abTestingGroup, z, hasAppc, hasSplits, malwareRank, storeName, z2, hasObbs, splitTypesAsString, r, appCategory, download.getSize());
        if (action2 == downloadAction) {
            ...
            r3 = kotlin.text.u.r(storeName, "catappult", false, 2, null);
            downloadAnalytics.migrationClicked(md5, versionCode2, packageName2, malwareRank, str, installType, action, hasAppc2, hasSplits2, storeName, z3, hasObbs2, splitTypesAsString2, r3, appCategory, download.getSize());
            return;
        }
        ...
        r2 = kotlin.text.u.r(storeName, "catappult", false, 2, null);
        downloadAnalytics2.installClicked(md52, versionCode3, packageName3, malwareRank, str2, mapDownloadAction, action, hasAppc3, hasSplits3, storeName, z4, hasObbs3, splitTypesAsString3, r2, appCategory, download.getSize());
    }
}
