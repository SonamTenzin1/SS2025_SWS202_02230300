...
public final class DownloadDialogProvider {
    ...
    private final rx.e<GenericDialogs.EResponse> showDialog(String str, String str2) {
        ...
        kotlin.jvm.internal.m.e(I0, "createGenericOkMessage(f…dSchedulers.mainThread())");
        return I0;
    }
    ...
    public final rx.e<Boolean> showDowngradeDialog() {
        ...
        kotlin.jvm.internal.m.e(X, "createGenericContinueCan…icDialogs.EResponse.YES }");
        return X;
    }
    ...
    public final rx.b showGenericError() {
        ...
        kotlin.jvm.internal.m.e(X0, "showDialog(\"\",\n        f…occured)).toCompletable()");
        return X0;
    }
    ...
    public final rx.b showOutOfSpaceError() {
        ...
        kotlin.jvm.internal.m.e(X0, "showDialog(fragment.getS…message)).toCompletable()");
        return X0;
    }
    ...
    public final rx.e<Boolean> showRootInstallWarningPopup() {
        ...
        kotlin.jvm.internal.m.e(X, "createGenericYesNoCancel…icDialogs.EResponse.YES }");
        return X;
    }
}
