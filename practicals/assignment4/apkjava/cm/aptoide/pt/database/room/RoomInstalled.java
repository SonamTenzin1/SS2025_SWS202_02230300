    ...
    private String getAppSignature(PackageInfo packageInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (signingCertificateHistory != null && signingCertificateHistory.length > 0) {
                byteArray = signingCertificateHistory[signingCertificateHistory.length - 1].toByteArray();
            } else {
                byteArray = packageInfo.signingInfo.getApkContentsSigners()[0].toByteArray();
            }
        } else {
