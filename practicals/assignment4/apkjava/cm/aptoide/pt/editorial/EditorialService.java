...
public class EditorialService {
    ...
    public Single<EditorialViewModel> loadEditorialViewModel(final String str) {
        ...
        return EditorialRequest.ofWithCardId(str, this.bodyInterceptorPoolV7, this.okHttpClient, this.converterFactory, this.tokenInvalidator, this.sharedPreferences).observe().y(new rx.m.a() { // from class: cm.aptoide.pt.editorial.e6
            @Override // rx.m.a
    ...
    public Single<EditorialViewModel> loadEditorialViewModelWithSlug(String str) {
        ...
        return EditorialRequest.ofWithSlug(str, this.bodyInterceptorPoolV7, this.okHttpClient, this.converterFactory, this.tokenInvalidator, this.sharedPreferences).observe().y(new rx.m.a() { // from class: cm.aptoide.pt.editorial.i6
            @Override // rx.m.a
            public final void call() {
