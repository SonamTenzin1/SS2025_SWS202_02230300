...
public final class EditorialRepository {
    ...
    public final Single<EditorialViewModel> loadEditorialViewModel(EditorialLoadSource editorialLoadSource) {
        ...
        if (editorialViewModel != null) {
            ...
            kotlin.jvm.internal.m.e(m, "just(cachedEditorialViewModel)");
            return m;
        }
        if (editorialLoadSource instanceof CardId) {
            single = this.editorialService.loadEditorialViewModel(((CardId) editorialLoadSource).getCardId()).n(new rx.m.e() { // from class: cm.aptoide.pt.editorial.d6
                @Override // rx.m.e
                public final Object call(Object obj) {
                    EditorialViewModel m145loadEditorialViewModel$lambda0;
                    m145loadEditorialViewModel$lambda0 = EditorialRepository.m145loadEditorialViewModel$lambda0(EditorialRepository.this, (EditorialViewModel) obj);
                    return m145loadEditorialViewModel$lambda0;
                }
            });
        } else {
            ...
            single = this.editorialService.loadEditorialViewModelWithSlug(((Slug) editorialLoadSource).getSlug()).n(new rx.m.e() { // from class: cm.aptoide.pt.editorial.c6
                @Override // rx.m.e
                public final Object call(Object obj) {
                    EditorialViewModel m146loadEditorialViewModel$lambda1;
                    m146loadEditorialViewModel$lambda1 = EditorialRepository.m146loadEditorialViewModel$lambda1(EditorialRepository.this, (EditorialViewModel) obj);
                    return m146loadEditorialViewModel$lambda1;
                }
            });
        }
        kotlin.jvm.internal.m.e(single, "when (editorialLoadSourc…wModel)\n        }\n      }");
        return single;
    }
}
