...
public final class ThemeManager {
    ...
    public final StoreTheme getBaseTheme() {
        ...
        m.e(storeTheme, "get(BuildConfig.APTOIDE_THEME, isThemeDark())");
        return storeTheme;
    }
    ...
    public final StoreTheme getStoreTheme(String storeThemeName) {
        ...
        m.e(storeTheme, "get(storeThemeName, isThemeDark())");
        return storeTheme;
    }
    ...
    public final TypedValue getAttributeForTheme(String themeName, int attributeResourceId) {
        ...
        m.e(peekValue, "activity.theme.obtainSty…ResourceId)).peekValue(0)");
        return peekValue;
    }
