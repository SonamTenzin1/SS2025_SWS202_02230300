...
public final /* data */ class AppCoinsAdvertisingModel {
    ...
    public AppCoinsAdvertisingModel(double d2, boolean z, double d3, String str, double d4, String str2) {
        kotlin.jvm.internal.m.f(str, "fiatCurrency");
        kotlin.jvm.internal.m.f(str2, "endDate");
        this.appcReward = d2;
    ...
    public boolean equals(Object other) {
        ...
        return kotlin.jvm.internal.m.a(Double.valueOf(this.appcReward), Double.valueOf(appCoinsAdvertisingModel.appcReward)) && this.hasAdvertising == appCoinsAdvertisingModel.hasAdvertising && kotlin.jvm.internal.m.a(Double.valueOf(this.fiatReward), Double.valueOf(appCoinsAdvertisingModel.fiatReward)) && kotlin.jvm.internal.m.a(this.fiatCurrency, appCoinsAdvertisingModel.fiatCurrency) && kotlin.jvm.internal.m.a(Double.valueOf(this.appcBudget), Double.valueOf(appCoinsAdvertisingModel.appcBudget)) && kotlin.jvm.internal.m.a(this.endDate, appCoinsAdvertisingModel.endDate);
    }
