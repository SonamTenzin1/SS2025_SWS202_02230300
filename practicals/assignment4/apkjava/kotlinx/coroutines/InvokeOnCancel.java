...
final class InvokeOnCancel extends CancelHandler {
    ...
    private final Function1<Throwable, kotlin.u> f25883f;

    /* JADX WARN: Multi-variable type inference failed */
    public InvokeOnCancel(Function1<? super Throwable, kotlin.u> function1) {
        this.f25883f = function1;
    }

    @Override // kotlinx.coroutines.CancelHandlerBase
    public void b(Throwable th) {
        this.f25883f.invoke(th);
    }
    ...
    public String toString() {
        return "InvokeOnCancel[" + t0.a(this.f25883f) + '@' + t0.b(this) + ']';
    }
}
