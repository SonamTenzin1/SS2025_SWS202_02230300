...
public final class NodeList extends LockFreeLinkedListHead implements Incomplete {
    public final String G(String str) {
        ...
        sb.append("}[");
        boolean z = true;
        for (LockFreeLinkedListNode lockFreeLinkedListNode = (LockFreeLinkedListNode) q(); !kotlin.jvm.internal.m.a(lockFreeLinkedListNode, this); lockFreeLinkedListNode = lockFreeLinkedListNode.r()) {
