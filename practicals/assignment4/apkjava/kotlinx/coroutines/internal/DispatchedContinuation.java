...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        CoroutineContext l = this.f25798k.getL();
        Object d2 = kotlinx.coroutines.e0.d(result, null, 1, null);
        if (this.f25797j.N(l)) {
            this.l = d2;
            this.f25647h = 0;
            this.f25797j.K(l, this);
            return;
        }
        s0.a();
        ...
        b2.e0(true);
        try {
            CoroutineContext l2 = getL();
            Object c2 = i0.c(l2, this.m);
            try {
