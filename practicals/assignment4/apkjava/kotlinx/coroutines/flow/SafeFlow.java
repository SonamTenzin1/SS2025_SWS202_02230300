...
final class SafeFlow<T> extends AbstractFlow<T> {
    ...
    private final Function2<FlowCollector<? super T>, Continuation<? super u>, Object> f25930f;

    /* JADX WARN: Multi-variable type inference failed */
    public SafeFlow(Function2<? super FlowCollector<? super T>, ? super Continuation<? super u>, ? extends Object> function2) {
        this.f25930f = function2;
    }

    @Override // kotlinx.coroutines.flow.AbstractFlow
    public Object b(FlowCollector<? super T> flowCollector, Continuation<? super u> continuation) {
        Object c2;
        Object invoke = this.f25930f.invoke(flowCollector, continuation);
        c2 = d.c();
