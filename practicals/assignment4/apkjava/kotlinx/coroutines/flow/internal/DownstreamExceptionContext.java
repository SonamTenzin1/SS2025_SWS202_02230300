...
/* renamed from: kotlinx.coroutines.flow.internal.d, reason: from Kotlin metadata */
/* loaded from: classes3.dex */
public final class DownstreamExceptionContext implements CoroutineContext {

    /* renamed from: f, reason: collision with root package name */
    public final Throwable f25757f;

    /* renamed from: g, reason: collision with root package name */
    private final /* synthetic */ CoroutineContext f25758g;

    public DownstreamExceptionContext(Throwable th, CoroutineContext coroutineContext) {
        this.f25757f = th;
        this.f25758g = coroutineContext;
    }

    @Override // kotlin.coroutines.CoroutineContext
    public <R> R fold(R r, Function2<? super R, ? super CoroutineContext.b, ? extends R> function2) {
        return (R) this.f25758g.fold(r, function2);
    }

    @Override // kotlin.coroutines.CoroutineContext
    public <E extends CoroutineContext.b> E get(CoroutineContext.c<E> cVar) {
        return (E) this.f25758g.get(cVar);
    }

    @Override // kotlin.coroutines.CoroutineContext
    public CoroutineContext minusKey(CoroutineContext.c<?> cVar) {
        return this.f25758g.minusKey(cVar);
    }

    @Override // kotlin.coroutines.CoroutineContext
    public CoroutineContext plus(CoroutineContext coroutineContext) {
        return this.f25758g.plus(coroutineContext);
    }
}
