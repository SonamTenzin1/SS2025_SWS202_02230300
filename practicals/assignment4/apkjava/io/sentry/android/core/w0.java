...
public final class w0 {
    ...
    private void C(io.sentry.protocol.e eVar, boolean z) {
        ...
        eVar.h0(bool);
        ActivityManager.MemoryInfo h2 = t0.h(this.f22268b, this.f22269c.getLogger());
        if (h2 != null && z) {
    ...
    private e.b s() {
        ...
        Throwable th;
        try {
            bVar = io.sentry.android.core.internal.util.o.a(this.f22268b.getResources().getConfiguration().orientation);
            if (bVar == null) {
                try {
    ...
    protected io.sentry.protocol.k B() {
        ...
        String g2 = t0.g(this.f22269c.getLogger());
        if (g2 != null) {
            kVar.i(g2);
        }
    ...
    public io.sentry.protocol.e a(boolean z, boolean z2) {
        ...
        DisplayMetrics e2 = t0.e(this.f22268b, this.f22269c.getLogger());
        if (e2 != null) {
