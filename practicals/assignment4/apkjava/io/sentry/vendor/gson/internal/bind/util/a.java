    ...
    */
    public static Date f(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            if (!a2 && str.length() <= i8) {
                GregorianCalendar gregorianCalendar = new GregorianCalendar(g2, g3 - 1, g4);
            ...
            if (a2) {
                ...
                if (str.length() > i11 && (charAt = str.charAt(i11)) != 'Z' && charAt != '+' && charAt != '-') {
                    ...
                    if (a(str, i12, '.')) {
                        int i13 = i12 + 1;
                        int d2 = d(str, i13 + 1);
                        int min = Math.min(d2, i13 + 3);
                        int g7 = g(str, i13, min);
                        int i14 = min - i13;
                        if (i14 == 1) {
                            g7 *= 100;
                        } else if (i14 == 2) {
                    ...
                    if (str.length() <= i8) {
                        ...
                        gregorianCalendar2.set(1, g2);
                        gregorianCalendar2.set(2, g3 - 1);
                        gregorianCalendar2.set(5, g4);
